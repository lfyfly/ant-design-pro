...
(function() {
                ...
                this._fs.readFile(r, { encoding: 'utf8' }, function(e, a) {
                  if (e) o(e);
                    ...
                    if (s._env.isElectronRenderer) {
                      var h = f.match(/^([a-z])\:(.*)/i);
                      f = h
                        ? 'file:///' + (h[1].toUpperCase() + ':' + h[2]).replace(/\\/g, '/')
                        : 'file://' + f;
                    }
                    var p,
            ...
            if (((this._inverseDependencies2[e.id] = null), c))
              for (var s = 0, u = c.length; s < u; s++) {
                ...
                f.unresolvedDependenciesCount--,
                  0 === f.unresolvedDependenciesCount && this._onModuleComplete(f);
              }
                ...
                do {
                  (C = M + o) === N || (C < S && d[C - 1] >= d[C + 1])
                    ...
                    : ((m = (f = d[C - 1]) - M - l),
                      ...
                      (M = C - 1 - o)),
                    P >= 0 &&
                      ((o = (d = this.m_reverseHistory[P])[0]), (N = 1), (S = d.length - 1));
                } while (--P >= -1);
                E = L.getChanges();
              }
            ...
            (e.prototype.ComputeRecursionPoint = function(e, t, r, i, s, u, a) {
              ...
              for (l = 1; l <= g / 2 + 1; l++) {
                var A = 0,
                  P = 0;
                for (
                  f = this.ClipDiagonalBound(C - l, l, C, _),
                    h = this.ClipDiagonalBound(C + l, l, C, _),
                    S = f;
                  S <= h;
                  S += 2
                ) {
                  for (
                    d =
                      (c = S === f || (S < h && v[S - 1] < v[S + 1]) ? v[S + 1] : v[S - 1] + 1) -
                      (S - C) -
                      E,
                      M = c;
                ...
                for (
                  p = this.ClipDiagonalBound(b - l, l, b, _),
                    m = this.ClipDiagonalBound(b + l, l, b, _),
                    S = p;
                  S <= m;
                  S += 2
                ) {
                  for (
                    d =
                      (c = S === p || (S < m && y[S - 1] >= y[S + 1]) ? y[S + 1] - 1 : y[S - 1]) -
                      (S - b) -
                      L,
                      M = c;
            ...
            (e.prototype.PrettifyChanges = function(e) {
              for (u = 0; u < e.length; u++) {
                for (
                  var t = e[u],
                    n =
                      u < e.length - 1 ? e[u + 1].originalStart : this.OriginalSequence.getLength(),
                    r =
                      u < e.length - 1 ? e[u + 1].modifiedStart : this.ModifiedSequence.getLength(),
                ...
                var s = [null];
                u < e.length - 1 &&
                  this.ChangesOverlap(e[u], e[u + 1], s) &&
                  ((e[u] = s[0]), e.splice(u + 1, 1), u--);
              }
  ...
  i(e[11], t([0, 1]), function(e, t) {
        ...
        i = (function() {
          ...
          return (
            ...
            (e.prototype._insert = function(e, t) {
              ...
              else (this._first = n), (this._last = n);
              return (this._size += 1), this._remove.bind(this, n);
            }),
            ...
            (e.prototype._remove = function(e) {
              for (var t = this._first; t instanceof r; ) {
                if (t === e) {
                  if (t.prev && t.next) {
                    var n = t.prev;
                    ...
                    t.prev || t.next
                      ? t.next
                        ? t.prev || ((this._first = this._first.next), (this._first.prev = void 0))
                        : ((this._last = this._last.prev), (this._last.next = void 0))
            ...
            (e.prototype.iterator = function() {
              ...
              return {
                next: function() {
                  return t
                    ? (e ? (e.value = t.element) : (e = { done: !1, value: t.element }),
                      (t = t.next),
                      e)
                    : n.FIN;
                },
                  ...
                  o = e(function(e) {
                    a++,
                      ...
                      (u = setTimeout(function() {
                        var e = s;
                        (s = void 0), (u = void 0), (!r || a > 1) && c.fire(e), (a = 0);
                      }, n));
                  });
                },
                onLastListenerRemove: function() {
          ...
          return (
            ...
            (e.prototype.check = function(e) {
              var t = this,
                n = u;
              if (
                ('number' == typeof this.customThreshold && (n = this.customThreshold),
                !(n <= 0 || e < n))
              ) {
                ...
                if (
                  (this._stacks.set(r, i + 1), (this._warnCountdown -= 1), this._warnCountdown <= 0)
                ) {
        ...
        l = (function() {
          function e(e) {
            (this._disposed = !1),
              (this._options = e),
              (this._leakageMon =
                u > 0 ? new a(this._options && this._options.leakWarningThreshold) : void 0);
          }
          return (
        ...
        function e() {
          ...
          (this.listening = !1),
            ...
            (this.emitter = new l({
              onFirstListenerDidAdd: function() {
                (e.listening = !0),
                  (e.inputEventListener = e.inputEvent(e.emitter.fire, e.emitter));
              },
              onLastListenerRemove: function() {
    ...
    i(e[3], t([0, 1]), function(e, t) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }), (t.LANGUAGE_DEFAULT = 'en');
      var n = !1,
        r = !1,
        i = !1,
        o = !1,
        s = !1,
        u = (t.LANGUAGE_DEFAULT,
        'undefined' != typeof process &&
          void 0 !== process.versions &&
          void 0 !== process.versions.electron &&
          'renderer' === process.type);
          ...
          if (
            (function(e) {
              return (
                ...
                !e.hasOwnProperty('arguments')
              );
            })(e)
          )
            return new ((r = e).bind.apply(r, [void 0].concat(t)))();
          ...
          return (
            ...
            (e.file = function(e) {
              ...
              if ((n.isWindows && (e = e.replace(/\\/g, h)), e[0] === h && e[1] === h)) {
                ...
                -1 === r
                  ? ((t = e.substring(2)), (e = h))
                  : ((t = e.substring(2, r)), (e = e.substring(r) || h));
              }
          ...
          return (
            ...
            (t.prototype.toString = function(e) {
              return (
                ...
                e
                  ? o(this, !0)
                  : (this._formatted || (this._formatted = o(this, !1)), this._formatted)
              );
            }),
        ...
        return (
          ...
          (e.prototype.initialize = function(e, t, n) {
            ...
            if ((this._protocol.setWorkerId(e), this._requestHandler)) {
              for (
                var i = [], s = 0, u = o.getAllPropertyNames(this._requestHandler);
                s < u.length;
                s++
              ) {
                var a = u[s];
                ...
                self.require(
                  ...
                  function() {
                    ...
                    if (((r._requestHandler = s.create()), r._requestHandler)) {
                      for (
                        var u = [], a = 0, l = o.getAllPropertyNames(r._requestHandler);
                        a < l.length;
                        a++
                      ) {
                        var c = l[a];
            ...
            (e.createFromDiffResult = function(t, n, r, o, u, a, c) {
              ...
              if (
                ...
                c &&
                  ...
                  (m = []);
                for (var y = 0, C = v.length; y < C; y++)
                  m.push(l.createFromDiffChange(v[y], g, _));
              }
          ...
          return (
              ...
              for (var o = [], s = 0, a = 0, n = -1, l = e.length; n < l; n++) {
                for (
                  ...
                  if (p !== m) {
                    ...
                    (g > 1 || _ > 1) &&
                      this._pushTrimWhitespaceCharChange(o, s + 1, 1, g, a + 1, 1, _);
                    for (
                    ...
                    (v < C || y < b) &&
                      this._pushTrimWhitespaceCharChange(o, s + 1, v, C, a + 1, y, b);
                  }
                  s++, a++;
                }
                d &&
            ...
            (e.prototype._pushTrimWhitespaceCharChange = function(e, t, n, r, i, o, s) {
              if (!this._mergeTrimWhitespaceCharChange(e, t, n, r, i, o, s)) {
                var u = void 0;
                this.shouldComputeCharChanges && (u = [new l(t, n, t, r, i, o, i, s)]),
                  e.push(new c(t, t, i, i, u));
              }
            }),
            (e.prototype._mergeTrimWhitespaceCharChange = function(e, t, n, r, i, o, s) {
              ...
              return (
                ...
                (a.originalEndLineNumber + 1 === t &&
                  ...
                  this.shouldComputeCharChanges &&
                    a.charChanges.push(new l(t, n, t, r, i, o, i, s)),
                  !0))
              );
            }),
    ...
    i(e[24], t([0, 1]), function(e, t) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.DEFAULT_WORD_REGEXP = (function(e) {
          void 0 === e && (e = '');
          for (
            var n = '(-?\\d*\\.\\d\\w*)|([^', r = 0, i = t.USUAL_WORD_SEPARATORS;
            r < i.length;
            r++
          ) {
            var o = i[r];
            ...
            i[0].indexOf(' ') >= 0
              ? (function(e, t, n, r) {
                  ...
                  for (var o; (o = t.exec(n)); ) {
                    ...
                    if (s > i) return null;
                    if (t.lastIndex >= i)
                      return { word: o[0], startColumn: r + 1 + s, endColumn: r + 1 + t.lastIndex };
                  }
                  return null;
                })(e, t, n, r)
              : (function(e, t, n, r) {
            ...
            (e._createLink = function(e, t, n, r, i) {
              ...
              if (r > 0) {
                var u = t.charCodeAt(r - 1),
                  a = t.charCodeAt(o);
                ((40 === u && 41 === a) || (91 === u && 93 === a) || (123 === u && 125 === a)) &&
                  o--;
              }
              return {
                range: {
 ...
 */,
    ...
    i(e[28], t([0, 1, 18, 9, 14, 12, 2, 6, 19, 20, 27, 32]), function(
      e,
      t,
      n,
      r,
      ...
      var i = (function() {
        ...
        return (
          ...
          (e.prototype._ensureLineStarts = function() {
            if (!this._lineStarts) {
              for (
                var e = this._eol.length, t = this._lines.length, n = new Uint32Array(t), i = 0;
                i < t;
                i++
              )
      ...
      var _ = (function(e) {
          ...
          return (
            ...
            (t.prototype.getWordAtPosition = function(e, t) {
              var n = f.getWordAtText(
                e.column,
                f.ensureValidWordDefinition(t),
            ...
            (t.prototype.getLineWords = function(e, t) {
              for (
                var n = this._lines[e - 1], r = [], i = 0, o = this._wordenize(n, t);
                i < o.length;
                i++
              ) {
                var s = o[i];
        ...
        v = (function() {
          ...
          return (
            ...
            (t.prototype.textualSuggest = function(e, n, r, i) {
              ...
              l[a.word] = !0;
              for (
                var c = o.createWordIterator(u), d = c.next();
                !d.done && s.length <= t._suggestionsLimit;
                d = c.next()
              ) {
                var f = d.value;
                l[f] ||
            ...
            (t.prototype.computeWordRanges = function(e, t, n, r) {
              ...
              for (
                var o = new RegExp(n, r), s = Object.create(null), u = t.startLineNumber;
                u < t.endLineNumber;
                u++
              )
            ...
            (t.prototype.loadForeignModule = function(t, n) {
              ...
              if (this._foreignModuleFactory) {
                ...
                for (
                  var o = [], s = 0, u = g.getAllPropertyNames(this._foreignModule);
                  s < u.length;
                  s++
                ) {
                  var a = u[s];
              ...
              return new Promise(function(o, s) {
                e(
                  ...
                  function(e) {
                    ...
                    for (
                      var t = [], s = 0, u = g.getAllPropertyNames(r._foreignModule);
                      s < u.length;
                      s++
                    ) {
                      var a = u[s];
