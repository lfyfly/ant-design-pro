...
define('vs/language/html/workerManager', ['require', 'exports'], function(e, t) {
  ...
  (function(e) {
    ...
    'use strict';
    var a, n, r, i, o, u, s, c, d, l, g, f, m, p, h, v, y, b, k, C, _, I, x, w, S, E, D, K, F, T, M;
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      ((s = t.LocationLink || (t.LocationLink = {})).create = function(e, t, n, r) {
      ...
      ((d = c = t.Color || (t.Color = {})).create = function(e, t, n, r) {
      ...
      ((g = t.ColorPresentation || (t.ColorPresentation = {})).create = function(e, t, n) {
      ...
      (g.is = function(e) {
        ...
        return (
          ...
          (ae.undefined(t.additionalTextEdits) || ae.typedArray(t.additionalTextEdits, _.is))
        );
      }),
      ((f = t.FoldingRangeKind || (t.FoldingRangeKind = {})).Comment = 'comment'),
      (f.Imports = 'imports'),
      (f.Region = 'region'),
      ((m = t.FoldingRange || (t.FoldingRange = {})).create = function(e, t, n, r, i) {
        var o = { startLine: e, endLine: t };
        return (
          ae.defined(n) && (o.startCharacter = n),
      ...
      (h.is = function(e) {
        var t = e;
        return ae.defined(t) && o.is(t.location) && ae.string(t.message);
      }),
      ((v = t.DiagnosticSeverity || (t.DiagnosticSeverity = {})).Error = 1),
      (v.Warning = 2),
      (v.Information = 3),
      (v.Hint = 4),
      ((b = y = t.Diagnostic || (t.Diagnostic = {})).create = function(e, t, n, r, i, o) {
      ...
      (b.is = function(e) {
        ...
        return (
          ...
          (ae.undefined(t.relatedInformation) || ae.typedArray(t.relatedInformation, p.is))
        );
      }),
      ((C = k = t.Command || (t.Command = {})).create = function(e, t) {
        for (var n = [], r = 2; r < arguments.length; r++) n[r - 2] = arguments[r];
        var i = { title: e, command: t };
        return ae.defined(n) && 0 < n.length && (i.arguments = n), i;
      }),
      (C.is = function(e) {
        var t = e;
        return ae.defined(t) && ae.string(t.title) && ae.string(t.command);
      }),
      ((I = _ = t.TextEdit || (t.TextEdit = {})).replace = function(e, t) {
      ...
      ((w = x = t.TextDocumentEdit || (t.TextDocumentEdit = {})).create = function(e, t) {
        return { textDocument: e, edits: t };
      }),
      (w.is = function(e) {
        var t = e;
        return ae.defined(t) && A.is(t.textDocument) && Array.isArray(t.edits);
      }),
      ((E = S = t.CreateFile || (t.CreateFile = {})).create = function(e, t) {
      ...
      ((K = D = t.RenameFile || (t.RenameFile = {})).create = function(e, t, n) {
      ...
      ((T = F = t.DeleteFile || (t.DeleteFile = {})).create = function(e, t) {
        ...
        return (
          ...
          (void 0 === t.documentChanges ||
            t.documentChanges.every(function(e) {
              return ae.string(e.kind) ? S.is(e) || D.is(e) || F.is(e) : x.is(e);
            }))
        );
      });
    var R,
      ...
      Q = (function() {
        ...
        return (
          ...
          (e.prototype.createFile = function(e, t) {
            this.checkDocumentChanges(), this._workspaceEdit.documentChanges.push(S.create(e, t));
          }),
    ...
    (t.WorkspaceChange = Q),
      ((R = t.TextDocumentIdentifier || (t.TextDocumentIdentifier = {})).create = function(e) {
        return { uri: e };
      }),
      (R.is = function(e) {
        var t = e;
      ...
      ((L = t.TextDocumentItem || (t.TextDocumentItem = {})).create = function(e, t, n, r) {
      ...
      ((j = O = t.MarkupKind || (t.MarkupKind = {})).PlainText = 'plaintext'),
      (j.Markdown = 'markdown'),
      ((W = O = t.MarkupKind || (t.MarkupKind = {})).is = function(e) {
        var t = e;
        return t === W.PlainText || t === W.Markdown;
      }),
      ((H = t.MarkupContent || (t.MarkupContent = {})).is = function(e) {
        var t = e;
        return ae.objectLiteral(e) && O.is(t.kind) && ae.string(t.value);
      }),
      ...
      (N.Operator = 24),
      (N.TypeParameter = 25),
      ((V = t.InsertTextFormat || (t.InsertTextFormat = {})).PlainText = 1),
      (V.Snippet = 2),
      ...
      ((q = U = t.MarkedString || (t.MarkedString = {})).fromPlainText = function(e) {
      ...
      ((t.Hover || (t.Hover = {})).is = function(e) {
        ...
        return (
          !!t &&
          ae.objectLiteral(t) &&
          (H.is(t.contents) || U.is(t.contents) || ae.typedArray(t.contents, U.is)) &&
      ...
      ((t.SignatureInformation || (t.SignatureInformation = {})).create = function(e, t) {
        ...
        var i = { label: e };
        return (
          ae.defined(t) && (i.documentation = t),
          ae.defined(n) ? (i.parameters = n) : (i.parameters = []),
          i
        );
      }),
      ((z = t.DocumentHighlightKind || (t.DocumentHighlightKind = {})).Text = 1),
      (z.Read = 2),
      (z.Write = 3),
      ...
      ((B = t.SymbolKind || (t.SymbolKind = {})).File = 1),
      (B.Module = 2),
      (B.Namespace = 3),
      (B.Package = 4),
      (B.Class = 5),
      ...
      (B.Operator = 25),
      (B.TypeParameter = 26),
      ((t.SymbolInformation || (t.SymbolInformation = {})).create = function(e, t, n, r, i) {
    ...
    var G,
      ...
      te = function() {};
    (t.DocumentSymbol = te),
      ((G = te = t.DocumentSymbol || (t.DocumentSymbol = {})).create = function(e, t, n, r, i, o) {
      ...
      (t.DocumentSymbol = te),
      ((J = t.CodeActionKind || (t.CodeActionKind = {})).QuickFix = 'quickfix'),
      (J.Refactor = 'refactor'),
      ...
      ((X = t.CodeActionContext || (t.CodeActionContext = {})).create = function(e, t) {
        var n = { diagnostics: e };
      ...
      ((Y = t.CodeAction || (t.CodeAction = {})).create = function(e, t, n) {
        var r = { title: e };
    ...
    (t.DocumentLink = oe),
      ...
      ((ie = t.TextDocumentSaveReason || (t.TextDocumentSaveReason = {})).Manual = 1),
      (ie.AfterDelay = 2),
      (ie.FocusOut = 3);
    var ae,
      ue,
  ...
  define('vs/language/html/languageFeatures', [
    ...
    function c(e) {
      if (e)
        return new u(e.start.line + 1, e.start.character + 1, e.end.line + 1, e.end.character + 1);
    }
    function d(e) {
    ...
    var r = (function() {
      ...
      return (
        ...
        (e.prototype.provideCompletionItems = function(i, o, e, t) {
          var n = i.uri;
          return this._worker(n)
            .then(function(e) {
              return e.doComplete(n.toString(), s(o));
            })
            .then(function(e) {
              if (e) {
                var t = i.getWordUntilPosition(o),
                  n = new u(o.lineNumber, t.startColumn, o.lineNumber, t.endColumn),
                  r = e.items.map(function(e) {
                    ...
                    return (
                      e.textEdit &&
                        ((t.range = c(e.textEdit.range)), (t.insertText = e.textEdit.newText)),
        ...
        (e.prototype.provideLinks = function(e, t) {
          ...
          return this._worker(n)
            ...
            .then(function(e) {
              if (e)
                return e.map(function(e) {
                  return { range: c(e.range), url: e.target };
                });
            });
        }),
        e
      ...
      return (
        (e.prototype.provideDocumentFormattingEdits = function(e, t, n) {
          ...
          return this._worker(r).then(function(e) {
            return e.format(r.toString(), null, m(t)).then(function(e) {
          ...
          return this._worker(i).then(function(e) {
            return e
              .format(
                i.toString(),
                (function(e) {
                  if (e) return { start: s(e.getStartPosition()), end: s(e.getEndPosition()) };
                })(t),
                m(n)
              )
              .then(function(e) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.setupMode = function(e) {
        var n = new i.WorkerManager(e),
          ...
          r = e.languageId;
        monaco.languages.registerCompletionItemProvider(r, new o.CompletionAdapter(t)),
          monaco.languages.registerHoverProvider(r, new o.HoverAdapter(t)),
          monaco.languages.registerDocumentHighlightProvider(r, new o.DocumentHighlightAdapter(t)),
          monaco.languages.registerLinkProvider(r, new o.DocumentLinkAdapter(t)),
          monaco.languages.registerFoldingRangeProvider(r, new o.FoldingRangeAdapter(t)),
          monaco.languages.registerDocumentSymbolProvider(r, new o.DocumentSymbolAdapter(t)),
          'html' === r &&
