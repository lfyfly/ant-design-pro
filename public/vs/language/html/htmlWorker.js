...
define('vscode-nls/vscode-nls', ['require', 'exports'], function(e, t) {
  'use strict';
  function n(e, t) {
    for (var n, i, r = [], a = 2; a < arguments.length; a++) r[a - 2] = arguments[a];
    return (
      (n = t),
      0 === (i = r).length
        ? n
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-html-languageservice/htmlLanguageTypes', ['require', 'exports'], e);
  })(function(e, t) {
    'use strict';
    var n, i, r;
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      ((i = t.TokenType || (t.TokenType = {}))[(i.StartCommentTag = 0)] = 'StartCommentTag'),
      ...
      (i[(i.EOS = 21)] = 'EOS'),
      ((r = t.ScannerState || (t.ScannerState = {}))[(r.WithinContent = 0)] = 'WithinContent'),
  ...
  (function(e) {
        ...
        return (
          ...
          (e.prototype.advanceUntilChars = function(e) {
            for (; this.position + e.length <= this.source.length; ) {
              for (
                var t = 0;
                t < e.length && this.source.charCodeAt(this.position + t) === e[t];
                t++
              );
    ...
    t.createScanner = function(e, t, n) {
      void 0 === t && (t = 0), void 0 === n && (n = g.ScannerState.WithinContent);
      var i,
        l,
        c,
        h,
        ...
        scan: function() {
          var e = u.pos(),
            ...
            n = (function e() {
              ...
              switch (p) {
                case g.ScannerState.WithinComment:
                  return u.advanceIfChars([v, v, w])
                    ? ((p = g.ScannerState.WithinContent), f(n, g.TokenType.EndCommentTag))
                    : (u.advanceUntilChars([v, v, w]), f(n, g.TokenType.Comment));
                case g.ScannerState.WithinDoctype:
                  return u.advanceIfChar(w)
                    ? ((p = g.ScannerState.WithinContent), f(n, g.TokenType.EndDoctypeTag))
                  ...
                  if (u.advanceIfChar(y)) {
                    if (!u.eos() && u.peekChar() === b) {
                      if (u.advanceIfChars([b, v, v]))
                        return (
                          (p = g.ScannerState.WithinComment), f(n, g.TokenType.StartCommentTag)
                        );
                      if (u.advanceIfRegExp(/^!doctype/i))
                        return (
                          (p = g.ScannerState.WithinDoctype), f(n, g.TokenType.StartDoctypeTag)
                        );
                    }
                    return u.advanceIfChar(T)
                      ? ((p = g.ScannerState.AfterOpeningEndTag), f(n, g.TokenType.EndTagOpen))
                      : ((p = g.ScannerState.AfterOpeningStartTag), f(n, g.TokenType.StartTagOpen));
                  }
                  return u.advanceUntilChar(y), f(n, g.TokenType.Content);
                case g.ScannerState.AfterOpeningEndTag:
                  var i = m();
                  return 0 < i.length
                    ? ((p = g.ScannerState.WithinEndTag), f(n, g.TokenType.EndTag))
                    : u.skipWhitespace()
                    ? f(
                        n,
                    ...
                    : ((p = g.ScannerState.WithinEndTag),
                      ...
                      n < u.pos()
                        ? f(
                            n,
                            g.TokenType.Unknown,
                            _('error.endTagNameExpected', 'End tag name expected.')
                          )
                        : e());
                case g.ScannerState.WithinEndTag:
                  if (u.skipWhitespace()) return f(n, g.TokenType.Whitespace);
                  if (u.advanceIfChar(w))
                    return (p = g.ScannerState.WithinContent), f(n, g.TokenType.EndTagClose);
                ...
                case g.ScannerState.AfterOpeningStartTag:
                  return (
                    ...
                    (h = d = void 0),
                    0 < c.length
                      ? ((l = !1), (p = g.ScannerState.WithinTag), f(n, g.TokenType.StartTag))
                      : u.skipWhitespace()
                      ? f(
                          n,
                          g.TokenType.Whitespace,
                      ...
                      : ((p = g.ScannerState.WithinTag),
                        ...
                        n < u.pos()
                          ? f(
                              n,
                              g.TokenType.Unknown,
                              _('error.startTagNameExpected', 'Start tag name expected.')
                            )
                          : e())
                  );
                case g.ScannerState.WithinTag:
                  return u.skipWhitespace()
                    ...
                    : l &&
                      0 <
                        (h = u.advanceIfRegExp(/^[^\s"'>/=\x00-\x0F\x7F\x80-\x9F]*/).toLowerCase())
                          .length
                    ? ((p = g.ScannerState.AfterAttributeName),
                      (l = !1),
                      f(n, g.TokenType.AttributeName))
                    : u.advanceIfChars([T, w])
                    ? ((p = g.ScannerState.WithinContent), f(n, g.TokenType.StartTagSelfClose))
                    : u.advanceIfChar(w)
                    ? ((p =
                        'script' === c
                          ? d && E[d]
                    ...
                    : (u.advance(1),
                      f(
                        n,
                        g.TokenType.Unknown,
                        _('error.unexpectedCharacterInTag', 'Unexpected character in tag.')
                      ));
                case g.ScannerState.AfterAttributeName:
                  return u.skipWhitespace()
                    ? ((l = !0), f(n, g.TokenType.Whitespace))
                    : u.advanceIfChar(S)
                    ? ((p = g.ScannerState.BeforeAttributeValue), f(n, g.TokenType.DelimiterAssign))
                ...
                case g.ScannerState.BeforeAttributeValue:
                  ...
                  return a === k || a === x
                    ? (u.advance(1),
                      ...
                      'type' === h && (d = u.getSource().substring(n + 1, u.pos() - 1)),
                      (p = g.ScannerState.WithinTag),
                      (l = !1),
                      f(n, g.TokenType.AttributeValue))
                ...
                case g.ScannerState.WithinScriptContent:
                  for (var o = 1; !u.eos(); ) {
                    ...
                    if (0 === s.length) return u.goToEnd(), f(n, g.TokenType.Script);
                    if ('\x3c!--' === s) 1 === o && (o = 2);
                    else if ('--\x3e' === s) o = 1;
                    else if ('/' !== s[1]) 2 === o && (o = 3);
                    else {
                  ...
                  return (
                    (p = g.ScannerState.WithinContent), n < u.pos() ? f(n, g.TokenType.Script) : e()
                  );
              ...
              return u.advance(1), (p = g.ScannerState.WithinContent), f(n, g.TokenType.Unknown, t);
            })();
          ...
          switch (s) {
            ...
            case p.TokenType.StartTagClose:
              (i.end = t.getTokenEnd()),
                ...
                i.tag && m.isVoidElement(i.tag) && i.parent && ((i.closed = !0), (i = i.parent));
              break;
            ...
            case p.TokenType.EndTagClose:
              if (a) {
                ...
                if (c.parent) {
                  for (; i !== c; ) (i.end = r), (i.closed = !1), (i = i.parent);
                  (i.closed = !0), (i.endTagStart = r), (i.end = t.getTokenEnd()), (i = i.parent);
                }
              }
              break;
            case p.TokenType.AttributeName:
              (o = t.getTokenText()), (h = i.attributes) || (i.attributes = h = {}), (h[o] = null);
              break;
  ...
  (function(e) {
    ...
    'use strict';
    var o, n, i, r, a, s, l, c, h, d, u, p, m, f, g, _, b, v, y, w, T, S, x, k, E, L, C, A, I, U, M;
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (s.is = function(e) {
        var t = e;
        return oe.defined(t) && i.is(t.range) && (oe.string(t.uri) || oe.undefined(t.uri));
      }),
      ...
      (l.is = function(e) {
        ...
        return (
          ...
          (i.is(t.targetSelectionRange) || oe.undefined(t.targetSelectionRange)) &&
      ...
      ((u = t.ColorPresentation || (t.ColorPresentation = {})).create = function(e, t, n) {
      ...
      (u.is = function(e) {
        ...
        return (
          ...
          (oe.undefined(t.additionalTextEdits) || oe.typedArray(t.additionalTextEdits, T.is))
        );
      }),
      ((p = t.FoldingRangeKind || (t.FoldingRangeKind = {})).Comment = 'comment'),
      (p.Imports = 'imports'),
      (p.Region = 'region'),
      ((m = t.FoldingRange || (t.FoldingRange = {})).create = function(e, t, n, i, r) {
      ...
      (_.Information = 3),
      (_.Hint = 4),
      ((v = b = t.Diagnostic || (t.Diagnostic = {})).create = function(e, t, n, i, r, a) {
      ...
      (v.is = function(e) {
        ...
        return (
          ...
          (oe.undefined(t.relatedInformation) || oe.typedArray(t.relatedInformation, f.is))
        );
      }),
      ...
      ((A = C = t.RenameFile || (t.RenameFile = {})).create = function(e, t, n) {
        ...
        return (
          ...
          (void 0 === t.documentChanges ||
            t.documentChanges.every(function(e) {
              return oe.string(e.kind) ? E.is(e) || C.is(e) || I.is(e) : x.is(e);
            }))
        );
      });
    var H,
      ...
      J = (function() {
        ...
        return (
          ...
          (e.prototype.createFile = function(e, t) {
            this.checkDocumentChanges(), this._workspaceEdit.documentChanges.push(E.create(e, t));
          }),
    ...
    (t.WorkspaceChange = J),
      ((H = t.TextDocumentIdentifier || (t.TextDocumentIdentifier = {})).create = function(e) {
        return { uri: e };
      }),
      (H.is = function(e) {
        var t = e;
      ...
      ((D = t.TextDocumentItem || (t.TextDocumentItem = {})).create = function(e, t, n, i) {
      ...
      ((B = F = t.MarkedString || (t.MarkedString = {})).fromPlainText = function(e) {
      ...
      ((t.Hover || (t.Hover = {})).is = function(e) {
        ...
        return (
          !!t &&
          oe.objectLiteral(t) &&
          (j.is(t.contents) || F.is(t.contents) || oe.typedArray(t.contents, F.is)) &&
      ...
      ((V = t.DocumentHighlightKind || (t.DocumentHighlightKind = {})).Text = 1),
      (V.Read = 2),
      (V.Write = 3),
    ...
    var Y,
      ...
      te = function() {};
    (t.DocumentSymbol = te),
      ((Y = te = t.DocumentSymbol || (t.DocumentSymbol = {})).create = function(e, t, n, i, r, a) {
      ...
      (($ = t.CodeActionContext || (t.CodeActionContext = {})).create = function(e, t) {
        var n = { diagnostics: e };
      ...
      ((Q = t.CodeAction || (t.CodeAction = {})).create = function(e, t, n) {
        var i = { title: e };
        return y.is(t) ? (i.command = t) : (i.edit = t), void 0 !== n && (i.kind = n), i;
      }),
      (Q.is = function(e) {
        var t = e;
        return (
      ...
      (Z.is = function(e) {
        var t = e;
        return oe.defined(t) && i.is(t.range) && (oe.undefined(t.command) || y.is(t.command));
      }),
    ...
    var ne,
      ...
      ae = function() {};
    (t.DocumentLink = ae),
      ((ne = ae = t.DocumentLink || (t.DocumentLink = {})).create = function(e, t, n) {
        return { range: e, target: t, data: n };
      }),
      (ne.is = function(e) {
        var t = e;
        return oe.defined(t) && i.is(t.range) && (oe.undefined(t.target) || oe.string(t.target));
      }),
      (t.DocumentLink = ae),
      (t.EOL = ['\n', '\r\n', '\r']),
      ...
      (ie.applyEdits = function(e, t) {
        for (
          ...
          (n = n.substring(0, s) + o.newText + n.substring(l, n.length)), (r = s);
        }
        return n;
      }),
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-html-languageservice/parser/htmlEntities', ['require', 'exports'], e);
  })(function(e, t) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.entities = {
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-html-languageservice/languageFacts/dataProvider', ['require', 'exports'], e);
  })(function(e, t) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 });
    var n = (function() {
      ...
      return (
        ...
        (e.prototype.provideAttributes = function(e) {
          var t = [],
            n = function(e) {
              t.push({ name: e.name, description: e.description, valueSet: e.valueSet });
            };
          return (
            this._tagMap[e] &&
  ...
  (function(e) {
          ...
          (e.prototype.doComplete = function(g, _, s, i) {
            var b = { isIncomplete: !1, items: [] },
              ...
              y = q.getAllDataProviders().filter(function(e) {
                return e.isApplicable(g.languageId) && (!i || !1 !== i[e.getId()]);
              }),
              w = g.getText(),
              T = g.offsetAt(_),
            ...
            function r(e, t, n) {
              void 0 === n && (n = T);
              var i = k(e, n),
                r = R(w, n, U.ScannerState.WithinEndTag, U.TokenType.EndTagClose) ? '' : '>',
                a = d;
              for (t && (a = a.parent); a; ) {
                var o = a.tag;
            ...
            function o(e, t) {
              ...
              var i = k(e, n),
                r = R(w, t, U.ScannerState.AfterAttributeName, U.TokenType.DelimiterAssign)
                  ? ''
                  : '="$1"',
                a = x.toLowerCase(),
                      ...
                      s.roots.forEach(function(e) {
                        return (function t(e) {
                          e.attributeNames.forEach(function(e) {
                            !H.startsWith(e, i) || r[e] || n[e] || (r[e] = e + '="$1"');
                          });
            ...
            function l(e, t) {
              var n, i, r, a;
              if ((void 0 === t && (t = T), e < T && T <= t && ((a = w[e]), /^["']*$/.test(a)))) {
                var o = e + 1,
                  s = t;
                e < t && w[t - 1] === w[e] && s--;
                ...
                (n = k(l, c)), (r = o <= T && T <= s ? w.substring(o, T) : ''), (i = !1);
            ...
            function c(e) {
              return T === t.getTokenEnd() && (m = t.scan()) === e && t.getTokenOffset() === T
                ? t.getTokenEnd()
                : T;
            }
            function h() {
              for (var e = 0, t = v; e < t.length; e++) {
                var n = t[e];
                n.onHtmlContent && n.onHtmlContent({ document: g, position: _ });
              }
              return E();
            }
            function E() {
              for (var e = T - 1, t = _.character; 0 <= e && H.isLetterOrDigit(w, e); ) e--, t--;
              if (0 <= e && '&' === w[e]) {
            ...
            for (var p, m = t.scan(); m !== U.TokenType.EOS && t.getTokenOffset() <= T; ) {
              switch (m) {
            ...
            if ('>' === r) {
              ...
              if (o && o.tag) {
                ...
                for (
                  ...
                  if (a === U.TokenType.EndTagOpen && s.getTokenEnd() === i) return o.tag + '>';
                  a = s.scan();
                }
              }
            }
    ...
    function R(e, t, n, i) {
      for (var r = I.createScanner(e, t, n), a = r.scan(); a === U.TokenType.Whitespace; )
        a = r.scan();
      return a === i;
    }
    t.HTMLCompletion = i;
    ...
    t.doHover = function(r, e, t) {
                ...
                (e.provideTags().forEach(function(e) {
                  if (e.name.toLowerCase() === r.toLowerCase()) {
                    var t = o ? '<' + r + '>' : '</' + r + '>',
                      n = e.description || '';
                    i = {
                      contents: [{ language: 'html', value: t }, d.MarkedString.fromPlainText(n)],
                      range: a,
                    };
                  }
                }),
      ...
      function o(e, t) {
        for (
          ...
          i !== u.TokenType.EOS && (n.getTokenEnd() < a || (n.getTokenEnd() === a && i !== e));

        )
          i = n.scan();
        return i === e && a <= n.getTokenEnd()
          ? { start: r.positionAt(n.getTokenOffset()), end: r.positionAt(n.getTokenEnd()) }
          : null;
      }
      ...
      function(e, t, n) {
        ...
        function i(e, t) {
          (this.__cache = ['']),
            ...
            (t = t || ''),
            0 < e.indent_level && (t = new Array(e.indent_level + 1).join(this.__indent_string)),
        ...
        (r.prototype.clone_empty = function() {
          ...
          (r.prototype.pop = function() {
            var e = null;
            return (
              this.is_empty() || ((e = this.__items.pop()), (this.__character_count -= e.length)), e
            );
          }),
      ...
      function(e, t, n) {
        ...
        (i.prototype.restart = function() {
          ...
          (i.prototype.test = function(e, t) {
            return (
              (t = t || 0),
              0 <= (t += this.__position) && t < this.__input_length && !!this.__match(e, t)
            );
          }),
      ...
      function(e, t, n) {
        ...
        (r.prototype.eatString = function(e) {
          ...
          (r.prototype.eatWhitespace = function(e) {
            for (var t = y.test(this._input.peek()), n = !0; y.test(this._input.peek()); )
              (this._ch = this._input.next()),
                e &&
                  '\n' === this._ch &&
          ...
          (r.prototype.beautify = function() {
            ...
            (this._output = new f(this._options, n)),
              ...
              (this._ch = null);
            for (
              var i, r, a = 0, o = !1, s = !1, l = !1, c = !1, h = !1, d = this._ch;
              ...
              if ('/' === this._ch && '*' === this._input.peek()) {
                ...
                if ((this.preserveSingleSpace(i), '{' === this._input.peek()))
                  ...
                  m.match(/[ :]$/) &&
                    ...
                    this.print_string(m),
                    (this._output.space_before_token = !0)),
                    'extend' === (m = m.replace(/\s$/, '')) ? (c = !0) : 'import' === m && (h = !0),
                    m in this.NESTED_AT_RULE
                      ? ((this._nestedLevel += 1), m in this.CONDITIONAL_GROUP_RULE && (l = !0))
                      : o || 0 !== a || -1 === m.indexOf(':') || ((s = !0), this.indent());
                }
              else
                '#' === this._ch && '{' === this._input.peek()
                  ? (this.preserveSingleSpace(i), this.print_string(this._ch + this.eatString('}')))
                  : '{' === this._ch
                  ? (s && ((s = !1), this.outdent()),
                    this.indent(),
                    (this._output.space_before_token = !0),
                  ...
                  ? (this.print_string(this._ch),
                    this.eatWhitespace(!0),
                    this._options.selector_separator_newline && !s && a < 1 && !h
                      ? this._output.add_new_line()
                      : (this._output.space_before_token = !0))
                  : ('>' === this._ch || '+' === this._ch || '~' === this._ch) && !s && a < 1
                  ...
                  : ('!' === this._ch ? this.print_string(' ') : this.preserveSingleSpace(i),
                    this.print_string(this._ch));
    ...
    var r = (function(n) {
      ...
      function(e, t, n) {
        ...
        (l.prototype.tokenize = function() {
          ...
          for (var t = new a(s.START, ''), n = null, i = [], r = new o(); t.type !== s.EOF; ) {
      ...
      function(e, t, n) {
        ...
        (i.prototype.restart = function() {
          ...
          (i.prototype.next = function() {
            var e = null;
            return (
              this.hasNext() && ((e = this.__tokens[this.__position]), (this.__position += 1)), e
            );
          }),
          (i.prototype.peek = function(e) {
            var t = null;
            return (
              (e = e || 0),
              0 <= (e += this.__position) && e < this.__tokens_length && (t = this.__tokens[e]),
              t
            );
          }),
        ...
        ((r.prototype = new i()).__set_whitespace_patterns = function(e, t) {
          ...
          (r.prototype.__split = function(e, t) {
            for (var n = (e.lastIndex = 0), i = [], r = e.exec(t); r; )
              i.push(t.substring(n, r.index)), (n = r.index + r[0].length), (r = e.exec(t));
      ...
      function(e, t, n) {
        ...
        (i.prototype.read = function() {
          ...
          (i.prototype.until_after = function(e) {
            var t = this._create();
            return (
              (t._until_after = !0), (t._until_pattern = this._input.get_regexp(e)), t._update(), t
            );
          }),
          (i.prototype.until = function(e) {
            var t = this._create();
            return (
              (t._until_after = !1), (t._until_pattern = this._input.get_regexp(e)), t._update(), t
            );
          }),
      ...
      function(e, t, n) {
        ...
        (p.prototype.current_line_has_match = function(e) {
          ...
          (p.prototype.print_preserved_newlines = function(e) {
            var t = 0;
            e.type !== h.TEXT && e.previous.type !== h.TEXT && (t = e.newlines ? 1 : 0),
        ...
        var o = function(e, t) {
          ...
          return t.closed
            ? ('script' === e ? (n = 'text/javascript') : 'style' === e && (n = 'text/css'),
              ...
              (n =
                (function(e) {
                  for (var t = null, n = e.next; n.type !== h.EOF && e.closed !== n; ) {
            ...
            if ('' !== t.text) {
              ...
              'javascript' === n.custom_beautifier_name && 'function' == typeof this._js_beautify
                ...
                : 'html' === n.custom_beautifier_name &&
                  (r = function(e, t) {
                    return new f(e, t, i._js_beautify, i._css_beautify).beautify();
                  }),
              ...
              if (((a = a.replace(/\n[ \t]*$/, '')), r)) {
                ...
                (l.prototype = this._options.raw_options), (a = r(s + a, new l()));
              } else {
        ...
        (f.prototype._get_tag_open_token = function(e) {
          ...
          return (
            ...
            (t.is_end_tag = t.is_end_tag || s(t.tag_check, this._options.void_elements)),
            (t.is_empty_element = t.tag_complete || (t.is_start_tag && t.is_end_tag)),
            (t.is_unformatted = !t.tag_complete && s(t.tag_check, this._options.unformatted)),
            (t.is_content_unformatted =
              !t.is_empty_element && s(t.tag_check, this._options.content_unformatted)),
            (t.is_inline_element = s(t.tag_name, this._options.inline) || '{' === t.tag_start_char),
            t
          );
        }),
        ...
        var a = n(9).Tokenizer,
          ...
          h = function(e, t) {
            ...
            if (
              ...
              this.__patterns.unformatted_content_delimiter = i.matching(r).until_after(r);
            }
          };
                        ...
                        (n =
                          (n =
                            (n =
                              ...
                              this._read_attribute(i, e, t)) || this._read_raw_content(e, t)) ||
                          this._read_close(i, t)) || this._read_content_word(i)) ||
                      this._read_comment(i)) || this._read_open(i, t)) ||
  ...
  (function(e) {
    ...
    t.format = function(e, t, n) {
      ...
      } else t = g.Range.create(g.Position.create(0, 0), e.positionAt(i.length));
      var p = {
          indent_size: o,
...
!(function(e) {
      ...
      return (
        ...
        (n.file = function(e) {
          ...
          if ((i && (e = e.replace(/\\/g, u)), e[0] === u && e[1] === u)) {
            var n = e.indexOf(u, 2);
            e =
              -1 === n ? ((t = e.substring(2)), u) : ((t = e.substring(2, n)), e.substring(n) || u);
          }
  ...
  function g(e, t) {
    ...
    if ((r && ((i += r), (i += ':')), (a || 'file' === r) && ((i += u), (i += u)), a)) {
      ...
      if (-1 !== c) {
        ...
        (a = a.substr(c + 1)),
          -1 === (c = h.indexOf(':'))
            ? (i += n(h, !1))
            : ((i += n(h.substr(0, c), !1)), (i += ':'), (i += n(h.substr(c + 1), !1))),
          (i += '@');
      }
    ...
    return s && ((i += '?'), (i += n(s, !1))), l && ((i += '#'), (i += t ? l : p(l, !1))), i;
  }
}),
  ...
  (function(e) {
    ...
    function g(e, t) {
      var n = e[0];
      return (
        n !== e[e.length - 1] || ("'" !== n && '"' !== n) || (e = e.substr(1, e.length - 2)), e
      );
    }
    function _(e, t, n, i, r, a) {
      ...
      var s,
        ...
        (c = t),
        (h = a),
        /^\s*javascript\:/i.test((l = o)) || /^\s*\#/i.test(l) || /[\n\r]/.test(l)
          ? null
          : ((l = l.replace(/^\s*/g, '')),
            /^https?:\/\//i.test(l) || /^file:\/\//i.test(l)
              ? l
              : /^\/\//i.test(l)
              ? (p.startsWith(s, 'https://') ? 'https' : 'http') + ':' + l.replace(/^\s*/g, '')
              : c
    ...
    t.findDocumentLinks = function(e, t) {
      for (
        var n = [], i = d.createScanner(e.getText(), 0), r = i.scan(), a = !1, o = !1, s = void 0;
        r !== f.TokenType.EOS;
  ...
  (function(e) {
    ...
    t.findDocumentHighlights = function(e, t, n) {
      ...
      var a = [],
        ...
        s = 'number' == typeof r.endTagStart && d(c.TokenType.EndTag, e, r.endTagStart);
      return (
        ((o && h(o, t)) || (s && h(s, t))) &&
        ...
        e.roots.forEach(function(e) {
          !(function t(n, e, i, r) {
            var a = c(e),
              ...
              s = { name: a, location: o, containerName: i, kind: l.SymbolKind.Field };
            r.push(s),
              e.children.forEach(function(e) {
                t(n, e, a, r);
              });
        ...
        switch (i) {
          ...
          case b.TokenType.StartTagSelfClose:
            ...
            if (0 <= d) {
              ...
              (h = u.startLine) < (f = p - 1) && s !== h && l({ startLine: h, endLine: f });
            }
            break;
            ...
            if (m)
              if (m[1]) a.push({ startLine: h, tagName: '' });
                ...
                if (0 <= d) {
                  ...
                  (h = u.startLine) < f &&
                    s !== h &&
                    l({ startLine: h, endLine: f, kind: _.FoldingRangeKind.Region });
                }
              }
            else
              h < (f = e.positionAt(n.getTokenOffset() + n.getTokenLength()).line) &&
                l({ startLine: h, endLine: f, kind: _.FoldingRangeKind.Comment });
        }
        i = n.scan();
      }
      ...
      return r.length > g
        ? (function(e, t) {
            ...
            for (s = 0; s < e.length; s++) {
              var p = r[s];
              'number' == typeof p && (p < h || (p === h && c++ < t)) && u.push(e[s]);
            }
            return u;
          })(r, g)
        : r;
      ...
      for (
        ...
        switch (s) {
          case f.TokenType.AttributeName:
            ...
            a <= o.getTokenEnd() && c.unshift([o.getTokenOffset(), o.getTokenEnd()]),
              (h = !0),
              (d = o.getTokenOffset());
            break;
          case f.TokenType.AttributeValue:
      ...
      return e.map(function(e) {
        var i = (function(e, t) {
          ...
          if (r.startTagEnd && !r.endTagStart) {
            var o = p.Range.create(e.positionAt(r.startTagEnd - 2), e.positionAt(r.startTagEnd)),
              s = e.getText(o);
            '/>' === s
          ...
          return (
            r.startTagEnd <= i && i <= r.endTagStart
              ...
              : i >= r.endTagStart + 2 && a.unshift([r.endTagStart + 2, r.end - 1]),
            a
          );
        })(t, e);
        return i
  ...
  (function(e) {
    ...
    t(e('./htmlLanguageTypes')),
      ...
      (n.getLanguageService = function(e) {
        ...
        return (
          e && e.customDataProviders && p.handleCustomDataProviders(e.customDataProviders),
          {
  ...
  define('vs/language/html/fillers/polyfills', ['require', 'exports'], function(e, t) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.polyfill = function() {
