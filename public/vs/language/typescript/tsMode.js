        ...
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(e) {
            switch (e.label) {
              case 0:
                return this._worker
                  ? ((t = ++this._updateExtraLibsToken), [4, this._worker.getProxy()])
                  : [2];
              case 1:
                return (
                  (n = e.sent()),
                  this._updateExtraLibsToken !== t
                    ? [2]
                    : (n.updateExtraLibs(this._defaults.getExtraLibs()), [2])
                );
            }
          });
        });
...
define('vs/language/typescript/languageFeatures', ['require', 'exports'], function(e, t) {
  ...
  var o = (function() {
    ...
    i = (function(s) {
      function e(e, r, t) {
        ...
        return (
          o._disposables.push(o._defaults.onDidChange(n)),
          o._disposables.push(o._defaults.onDidExtraLibsChange(n)),
  ...
  var a = (function(e) {
    ...
    return (
      __extends(u, e),
      Object.defineProperty(u.prototype, 'triggerCharacters', {
        get: function() {
          return ['.'];
        },
        enumerable: !0,
      ...
      (u.prototype.provideCompletionItems = function(o, i, e, t) {
        var n = o.getWordUntilPosition(i),
          a = new c(i.lineNumber, n.startColumn, i.lineNumber, n.endColumn),
          s = o.uri,
          r = this._positionToOffset(s, i);
        return this._worker(s)
          .then(function(e) {
            return e.getCompletionsAtPosition(s.toString(), r);
          })
          .then(function(e) {
            if (e)
              return {
                suggestions: e.entries.map(function(e) {
                  ...
                  if (e.replacementSpan) {
                    var n = o.getPositionAt(e.replacementSpan.start),
                      r = o.getPositionAt(e.replacementSpan.start + e.replacementSpan.length);
                    t = new c(n.lineNumber, n.column, r.lineNumber, r.column);
                  }
                  return {
                    uri: s,
                    position: i,
          ...
          .then(function(e) {
            return e
              ? {
                  ...
                  label: e.name,
                  kind: u.convertKind(e.kind),
                  detail: l(e.displayParts),
                  documentation: { value: l(e.documentation) },
                }
              : i;
          });
      }),
            ...
            if (e) {
              ...
              return (
                e.items.forEach(function(i) {
                  ...
                  (a.label += l(i.prefixDisplayParts)),
                    i.parameters.forEach(function(e, t, n) {
                      var r = l(e.displayParts),
                        o = { label: r, documentation: l(e.documentation) };
                      (a.label += r),
                        a.parameters.push(o),
                        t < n.length - 1 && (a.label += l(i.separatorDisplayParts));
                    }),
                    (a.label += l(i.suffixDisplayParts)),
                    t.signatures.push(a);
                }),
                t
              );
            ...
            if (e) {
              for (var t = [], n = 0, r = e; n < r.length; n++) {
                ...
                monaco.editor.getModel(i) &&
                  t.push({ uri: i, range: a._textSpanToRange(i, o.textSpan) });
              }
              return t;
            }
          });
  ...
  (_[h.module] = monaco.languages.SymbolKind.Module),
    (_[h.class] = monaco.languages.SymbolKind.Class),
    (_[h.enum] = monaco.languages.SymbolKind.Enum),
    (_[h.interface] = monaco.languages.SymbolKind.Interface),
    (_[h.memberFunction] = monaco.languages.SymbolKind.Method),
    (_[h.memberVariable] = monaco.languages.SymbolKind.Property),
    (_[h.memberGetAccessor] = monaco.languages.SymbolKind.Property),
    (_[h.memberSetAccessor] = monaco.languages.SymbolKind.Property),
    (_[h.variable] = monaco.languages.SymbolKind.Variable),
    (_[h.const] = monaco.languages.SymbolKind.Variable),
    (_[h.localVariable] = monaco.languages.SymbolKind.Variable),
    (_[h.variable] = monaco.languages.SymbolKind.Variable),
    (_[h.function] = monaco.languages.SymbolKind.Function),
    (_[h.localFunction] = monaco.languages.SymbolKind.Function);
  var v = (function(e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
          ...
          return this._worker(i)
            .then(function(e) {
              return e.getFormattingEditsForRange(
                i.toString(),
                o._positionToOffset(i, { lineNumber: t.startLineNumber, column: t.startColumn }),
                o._positionToOffset(i, { lineNumber: t.endLineNumber, column: t.endColumn }),
                v._convertOptions(n)
              );
            })
            .then(function(e) {
  ...
  define('vs/language/typescript/tsMode', [
    ...
    function a(e, t) {
      ...
      return (
        monaco.languages.registerCompletionItemProvider(t, new i.SuggestAdapter(n)),
        monaco.languages.registerSignatureHelpProvider(t, new i.SignatureHelpAdapter(n)),
        monaco.languages.registerHoverProvider(t, new i.QuickInfoAdapter(n)),
        monaco.languages.registerDocumentHighlightProvider(t, new i.OccurrencesAdapter(n)),
        monaco.languages.registerDefinitionProvider(t, new i.DefinitionAdapter(n)),
        monaco.languages.registerReferenceProvider(t, new i.ReferenceAdapter(n)),
        monaco.languages.registerDocumentSymbolProvider(t, new i.OutlineAdapter(n)),
        monaco.languages.registerDocumentRangeFormattingEditProvider(t, new i.FormatAdapter(n)),
        monaco.languages.registerOnTypeFormattingEditProvider(t, new i.FormatOnTypeAdapter(n)),
        new i.DiagnostcsAdapter(e, t, n),
        n
      );
    }
    Object.defineProperty(t, '__esModule', { value: !0 }),
