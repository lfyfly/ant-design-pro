    ...
    return (
      ...
      (e.prototype.scanUnquotedString = function() {
        var e = this.stream.pos(),
          t = [];
        return this._unquotedString(t) ? this.finishToken(e, a.UnquotedString, t.join('')) : null;
      }),
      (e.prototype.scan = function() {
        var e = this.trivia();
        if (null !== e) return e;
        var t = this.stream.pos();
        return this.stream.eos() ? this.finishToken(t, a.EOF) : this.scanNext(t);
      }),
      (e.prototype.scanNext = function(e) {
        if (this.stream.advanceIfChars([S, $, b, b])) return this.finishToken(e, a.CDO);
        if (this.stream.advanceIfChars([b, b, T])) return this.finishToken(e, a.CDC);
        var t = [];
        ...
        if (this.stream.advanceIfChar(F))
          return (
            (t = ['#']),
            this._name(t) ? this.finishToken(e, a.Hash, t.join('')) : this.finishToken(e, a.Delim)
          );
        if (this.stream.advanceIfChar($)) return this.finishToken(e, a.Exclamation);
        if (this._number()) {
          var i = this.stream.pos();
          if (((t = [this.stream.substring(e, i)]), this.stream.advanceIfChar(v)))
      ...
      (e.prototype.trivia = function() {
        for (;;) {
          var e = this.stream.pos();
          if (this._whitespace()) {
            if (!this.ignoreWhitespace) return this.finishToken(e, a.Whitespace);
          } else {
      ...
      (e.prototype._escape = function(e, t) {
        ...
        if (n === I) {
          ...
          for (
            var i = 0;
            i < 6 && ((p <= n && n <= h) || (o <= n && n <= s) || (l <= n && n <= c));

          )
            this.stream.advance(1), (n = this.stream.peekChar()), i++;
          if (0 < i) {
            try {
              var r = parseInt(this.stream.substring(this.stream.pos() - i), 16);
              r && e.push(String.fromCharCode(r));
            } catch (e) {}
            return n === O || n === N ? this.stream.advance(1) : this._newline([]), !0;
          }
          if (n !== A && n !== D && n !== _)
      ...
      (e.prototype._string = function(e) {
        if (this.stream.peekChar() !== R && this.stream.peekChar() !== z) return null;
      ...
      (e.prototype._identFirstChar = function(e) {
        var t = this.stream.peekChar();
        return (
          (t === y || (o <= t && t <= r) || (l <= t && t <= d) || (128 <= t && t <= 65535)) &&
          (this.stream.advance(1), e.push(String.fromCharCode(t)), !0)
        );
      }),
      (e.prototype._minus = function(e) {
        var t = this.stream.peekChar();
        return t === b && (this.stream.advance(1), e.push(String.fromCharCode(t)), !0);
      }),
...
!(function(e) {
    ...
    return !e || t < e.offset || t > e.end
      ...
      : (e.accept(function(e) {
          return (
            ...
            (e.offset <= t && e.end >= t && (n ? e.length <= n.length && (n = e) : (n = e), !0))
          );
        }),
        n);
  }
  Object.defineProperty(t, '__esModule', { value: !0 }),
    ((n = r = t.NodeType || (t.NodeType = {}))[(n.Undefined = 0)] = 'Undefined'),
    ...
    (n[(n.SelectorCombinatorAllSiblings = 10)] = 'SelectorCombinatorAllSiblings'),
  ...
  var s = (function() {
      ...
      return (
        ...
        (e.prototype.endsWith = function(e) {
          return (
            this.length >= e.length && this.getTextProvider()(this.end - e.length, e.length) === e
          );
        }),
        ...
        (e.prototype.adoptChild = function(e, t) {
          ...
          return i || (i = this.children = []), -1 !== t ? i.splice(t, 0, e) : i.push(e), e;
        }),
    ...
    h = (function(n) {
      ...
      return (
        ...
        (e.prototype.isNested = function() {
          return !!this.parent && null !== this.parent.findParent(r.Declarations);
        }),
        e
      );
    })((t.BodyDeclaration = p));
  ...
  var _ = (function(n) {
    ...
    return (
      ...
      (e.prototype.getParameters = function() {
        return this.parameters || (this.parameters = new a(this)), this.parameters;
      }),
      e
    );
  })(p);
  ...
  var se = (function(n) {
    ...
    return (
      ...
      (e.prototype.getNamespaces = function() {
        return this.namespaces || (this.namespaces = new a(this)), this.namespaces;
      }),
      (e.prototype.setIdentifier = function(e) {
        return this.setNode('identifier', e, 0);
      }),
  ...
  var de = (function(e) {
    ...
    return (
      ...
      (t.prototype.getConditions = function() {
        return this.conditions || (this.conditions = new a(this)), this.conditions;
      }),
      t
    );
  })(s);
  ...
  define('vscode-nls/vscode-nls', ['require', 'exports'], function(e, t) {
    'use strict';
    function n(e, t) {
      for (var n, i, r = [], o = 2; o < arguments.length; o++) r[o - 2] = arguments[o];
      return (
        (n = t),
        0 === (i = r).length
          ? n
  ...
  (function(e) {
    ...
    (t.CSSIssueType = i),
      (t.ParseError = {
        NumberExpected: new i('css-numberexpected', n('expected.number', 'number expected')),
        ...
        DotExpected: new i('css-dotexpected', n('expected.dot', 'dot expected')),
        ColonExpected: new i('css-colonexpected', n('expected.colon', 'colon expected')),
        SemiColonExpected: new i(
          'css-semicolonexpected',
          n('expected.semicolon', 'semi-colon expected')
        ),
        TermExpected: new i('css-termexpected', n('expected.term', 'term expected')),
        ...
        URIExpected: new i('css-uriexpected', n('expected.uri', 'URI expected')),
        ...
        LeftCurlyExpected: new i('css-lcurlyexpected', n('expected.lcurly', '{ expected')),
        RightCurlyExpected: new i('css-rcurlyexpected', n('expected.rcurly', '} expected')),
        ...
        LeftParenthesisExpected: new i('css-lparentexpected', n('expected.lparen', '( expected')),
        RightParenthesisExpected: new i('css-rparentexpected', n('expected.rparent', ') expected')),
        CommaExpected: new i('css-commaexpected', n('expected.comma', 'comma expected')),
        ...
        UnknownAtRule: new i('css-unknownatrule', n('unknown.atrule', 'at-rule unknown')),
        UnknownKeyword: new i('css-unknownkeyword', n('unknown.keyword', 'unknown keyword')),
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.cssData = {
        ...
        properties: [
          ...
          {
            name: 'box-shadow',
            values: [{ name: 'inset' }, { name: 'none', description: 'No shadow.' }],
            syntax: 'none | <shadow>#',
            description:
          ...
          {
            name: 'empty-cells',
            values: [{ name: 'hide' }, { name: '-moz-show-background' }, { name: 'show' }],
            syntax: 'show | hide',
            description:
          ...
          },
          {
            ...
            values: [
              ...
              { name: 'no-contextual', browsers: ['FF34', 'S9.1', 'C34', 'O21'] },
          ...
          },
          {
            ...
            values: [
              ...
              { name: 'cross-slide-x', browsers: ['E12', 'FF52', 'C36', 'IE11', 'O23'] },
              { name: 'cross-slide-y', browsers: ['E12', 'FF52', 'C36', 'IE11', 'O23'] },
              { name: 'double-tap-zoom', browsers: ['E12', 'FF52', 'C36', 'IE11', 'O23'] },
              {
                name: 'manipulation',
                description:
              ...
              { name: 'pinch-zoom', browsers: ['E12', 'FF52', 'C36', 'IE11', 'O23'] },
            ],
            syntax:
          ...
          },
          {
            ...
            values: [
              { name: 'flat' },
              { name: 'preserve-3d', browsers: ['E12', 'FF16', 'S', 'C12', 'O15'] },
            ],
        ...
        pseudoClasses: [
          ...
          { name: ':empty', description: 'Represents an element that has no children at all.' },
          {
            name: ':enabled',
            description:
          ...
          { name: ':link', description: 'Applies to links that have not yet been visited.' },
          {
            name: ':matches()',
            browsers: ['S9'],
            description:
          ...
          { name: ':visited', description: 'Applies once the link has been visited by the user.' },
          {
            name: ':-webkit-any()',
            browsers: ['C', 'S5'],
            description:
        ...
        pseudoElements: [
          ...
          { name: '::-webkit-meter-even-less-good-value', browsers: ['S', 'C', 'O'] },
          ...
          { name: '::-webkit-scrollbar-track-piece', browsers: ['S', 'C', 'O15'] },
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-css-languageservice/utils/objects', ['require', 'exports'], e);
  })(function(e, t) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.values = function(t) {
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-css-languageservice/languageFacts/dataManager', [
          'require',
          'exports',
          '../utils/objects',
        ], e);
      ...
      i = (function() {
        ...
        return (
            ...
            this.dataProviders.forEach(function(e) {
              e.provideProperties().forEach(function(e) {
                ...
                e.providePseudoElements().forEach(function(e) {
                  t._pseudoElementSet[e.name] || (t._pseudoElementSet[e.name] = e);
                });
            }),
          ...
          (e.prototype.getProperties = function(e) {
            return void 0 === e && (e = !0), e ? this._properties.filter(r) : this._properties;
          }),
          (e.prototype.getAtDirectives = function(e) {
            return void 0 === e && (e = !0), e ? this._atDirectives.filter(r) : this._atDirectives;
          }),
          (e.prototype.getPseudoClasses = function(e) {
            return (
              void 0 === e && (e = !0), e ? this._pseudoClasses.filter(r) : this._pseudoClasses
            );
          }),
          (e.prototype.getPseudoElements = function(e) {
            return (
              void 0 === e && (e = !0), e ? this._pseudoElements.filter(r) : this._pseudoElements
            );
          }),
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-css-languageservice/languageFacts/dataProvider', ['require', 'exports'], e);
  })(function(e, t) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 });
    var n = (function() {
      ...
      return (
        ...
        (e.prototype.addData = function(e) {
          e.properties && (this._properties = this._properties.concat(e.properties)),
            ...
            e.pseudoElements &&
              (this._pseudoElements = this._pseudoElements.concat(e.pseudoElements));
        }),
        e
      );
    })();
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-css-languageservice/languageFacts/entry', ['require', 'exports'], e);
  })(function(e, o) {
    'use strict';
    function i(e) {
      return e && 0 !== e.length
        ? e
            .map(function(e) {
              var t = '',
                ...
                i = n[1],
                r = n[2];
              return i in o.browserNames && (t += o.browserNames[i]), r && (t += ' ' + r), t;
            })
            .join(', ')
        : null;
    }
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-css-languageservice/languageFacts/colors', [
          'require',
          'exports',
          '../parser/cssNodes',
          'vscode-nls',
    ...
    function m(e, t, n, i) {
      if ((void 0 === i && (i = 1), 0 === t)) return { red: n, green: n, blue: n, alpha: i };
      var r = function(e, t, n) {
        ...
        s = 2 * n - o;
      return { red: r(s, o, (e /= 60) + 2), green: r(s, o, e), blue: r(s, o, e - 2), alpha: i };
    }
    (c.hexDigit = l),
      (c.colorFromHex = h),
      (c.colorFrom256RGB = function(e, t, n, i) {
        return void 0 === i && (i = 1), { red: e / 255, green: t / 255, blue: n / 255, alpha: i };
      }),
      (c.colorFromHSL = m),
      ...
      (c.getColorValue = function(e) {
        ...
        if (e.type === d.NodeType.Function) {
          ...
          try {
            ...
            if ('rgb' === n || 'rgba' === n)
              return { red: p(i[0], 255), green: p(i[1], 255), blue: p(i[2], 255), alpha: r };
            if ('hsl' === n || 'hsla' === n)
              return m(
                (function(e) {
                  var t = e.getText();
          ...
          if (o.parent && o.parent.type === d.NodeType.BinaryExpression) {
            var s = o.parent;
            if (s.parent && s.parent.type === d.NodeType.ListEntry && s.parent.key === s)
              return null;
          }
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-css-languageservice/languageFacts/builtinData', ['require', 'exports'], e);
  })(function(e, t) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.positionKeywords = {
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-css-languageservice/languageFacts/facts', [
          'require',
          'exports',
          '../data/browsers',
          './dataManager',
    ...
    t(e('./entry')),
      ...
      t(e('./dataProvider')),
      t(e('./dataManager')),
      (n.cssDataManager = new r.CSSDataManager([new o.CSSDataProvider(i.cssData)]));
  }),
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      var t = e(require, exports);
      ...
      i = (function() {
        ...
        return (
          ...
          (e.prototype.peekDelim = function(e) {
            return s.TokenType.Delim === this.token.type && e === this.token.text;
          }),
          ...
          (e.prototype.hasWhitespace = function() {
            return (
              this.prevToken && this.prevToken.offset + this.prevToken.len !== this.token.offset
            );
          }),
          ...
          (e.prototype.markError = function(e, t, n, i) {
            this.token !== this.lastErrorToken &&
              (e.addIssue(
                new a.Marker(e, t, a.Level.Error, null, this.token.offset, this.token.len)
              ),
          ...
          (e.prototype.parseStylesheet = function(n) {
            var i = n.version;
            return this.internalParse(n.getText(), this._parseStylesheet, function(e, t) {
              if (n.version !== i)
          ...
          (e.prototype._tryParseRuleset = function(e) {
            ...
            if (this._parseSelector(e)) {
              for (; this.accept(s.TokenType.Comma) && this._parseSelector(e); );
          ...
          (e.prototype._parseDeclarations = function(e) {
            ...
            for (var n = e(); t.addChild(n) && !this.peek(s.TokenType.CurlyR); ) {
              if (this._needsSemicolonAfter(n) && !this.accept(s.TokenType.SemiColon))
                ...
                ? ((t.colonPosition = this.prevToken.offset),
                  t.setValue(this._parseExpr())
                    ? (t.addChild(this._parsePrio()),
                      this.peek(s.TokenType.SemiColon) && (t.semicolonPosition = this.token.offset),
                      this.finish(t))
                    : this.finish(t, l.ParseError.PropertyValueExpected))
                : this.finish(t, l.ParseError.ColonExpected, [s.TokenType.Colon], e)
              : null;
          }),
          (e.prototype._tryParseCustomPropertyDeclaration = function() {
            ...
            if (!this.accept(s.TokenType.Colon))
              return this.finish(e, l.ParseError.ColonExpected, [s.TokenType.Colon]);
            e.colonPosition = this.prevToken.offset;
            var t = this.mark();
            if (this.peek(s.TokenType.CurlyL)) {
              var n = this.create(a.CustomPropertySet),
                i = this._parseDeclarations(this._parseRuleSetDeclaration.bind(this));
              if (
                n.setDeclarations(i) &&
                !i.isErroneous(!0) &&
                (n.addChild(this._parsePrio()), this.peek(s.TokenType.SemiColon))
              )
                return (
                  this.finish(n),
                  e.setPropertySet(n),
            ...
            return r && !r.isErroneous(!0) && (this._parsePrio(), this.peek(s.TokenType.SemiColon))
              ? (e.setValue(r), (e.semicolonPosition = this.token.offset), this.finish(e))
              : (this.restoreAtMark(t),
            ...
            e: for (;;) {
              switch (this.token.type) {
                ...
                case s.TokenType.ParenthesisR:
                  if (--i < 0) return this.finish(e, l.ParseError.LeftParenthesisExpected);
                  break;
                case s.TokenType.BracketL:
                  r++;
                  break;
                case s.TokenType.BracketR:
                  if (--r < 0) return this.finish(e, l.ParseError.LeftSquareBracketExpected);
                  break;
            ...
            return (
              ...
              e.addChild(this._parseURILiteral()) || e.addChild(this._parseStringLiteral()))
                ? this.accept(s.TokenType.SemiColon)
                  ? this.finish(e)
                  : this.finish(e, l.ParseError.SemiColonExpected)
                : this.finish(e, l.ParseError.URIExpected, [s.TokenType.SemiColon])
            );
          }),
          (e.prototype._parseFontFace = function() {
            ...
            return (
              this.consumeToken(), this._parseBody(e, this._parseRuleSetDeclaration.bind(this))
            );
          }),
          ...
          (e.prototype._parseKeyframe = function() {
            if (!this.peekRegExp(s.TokenType.AtKeyword, this.keyframeRegex)) return null;
            var e = this.create(a.Keyframe),
              t = this.create(a.Node);
            return (
              this.consumeToken(),
              e.setKeyword(this.finish(t)),
              '@-ms-keyframes' === t.getText() && this.markError(t, l.ParseError.UnknownKeyword),
              e.setIdentifier(this._parseKeyframeIdent())
                ? this._parseBody(e, this._parseKeyframeSelector.bind(this))
                : this.finish(e, l.ParseError.IdentifierExpected, [s.TokenType.CurlyR])
            );
          }),
          ...
          (e.prototype._parseKeyframeSelector = function() {
            ...
            if (!e.addChild(this._parseIdent()) && !this.accept(s.TokenType.Percentage))
              return null;
            for (; this.accept(s.TokenType.Comma); )
              if (!e.addChild(this._parseIdent()) && !this.accept(s.TokenType.Percentage))
          ...
          (e.prototype._parseSupportsConditionInParens = function() {
            ...
            if (this.peek(s.TokenType.Ident)) {
              ...
              if (
                ...
                for (var n = 1; this.token.type !== s.TokenType.EOF && 0 !== n; )
          ...
          (e.prototype._parseMediaQuery = function(e) {
            ...
            for (; n; ) {
              if (!this.accept(s.TokenType.ParenthesisL))
                return i ? this.finish(t, l.ParseError.LeftParenthesisExpected, [], e) : null;
              if (!t.addChild(this._parseMediaFeatureName()))
                return this.finish(t, l.ParseError.IdentifierExpected, [], e);
              if (this.accept(s.TokenType.Colon) && !t.addChild(this._parseExpr()))
                return this.finish(t, l.ParseError.TermExpected, [], e);
              if (!this.accept(s.TokenType.ParenthesisR))
                return this.finish(t, l.ParseError.RightParenthesisExpected, [], e);
          ...
          (e.prototype._parsePageMarginBox = function() {
            ...
            return (
              this.acceptOneKeyword(n.pageBoxDirectives) ||
                this.markError(e, l.ParseError.UnknownAtRule, [], [s.TokenType.CurlyL]),
              this._parseBody(e, this._parseRuleSetDeclaration.bind(this))
            );
          }),
          (e.prototype._parsePageSelector = function() {
            if (!this.peek(s.TokenType.Ident) && !this.peek(s.TokenType.Colon)) return null;
            var e = this.create(a.Node);
            return (
              e.addChild(this._parseIdent()),
                ...
                case s.TokenType.CurlyR:
                  if ((n--, 0 < t && 0 === n)) {
                    if ((this.consumeToken(), 0 < r))
                      return this.finish(e, l.ParseError.RightSquareBracketExpected);
                    if (0 < i) return this.finish(e, l.ParseError.RightParenthesisExpected);
                    break e;
                  }
                  if (n < 0) {
                    if (0 === i && 0 === r) break e;
          ...
          (e.prototype._parseCombinator = function() {
            if (this.peekDelim('>')) {
              ...
              if (!this.hasWhitespace() && this.acceptDelim('>')) {
                if (!this.hasWhitespace() && this.acceptDelim('>'))
                  return (
                    (e.type = a.NodeType.SelectorCombinatorShadowPiercingDescendant), this.finish(e)
                  );
                this.restoreAtMark(t);
              }
              return (e.type = a.NodeType.SelectorCombinatorParent), this.finish(e);
            }
            if (this.peekDelim('+')) {
              e = this.create(a.Node);
              return (
                this.consumeToken(), (e.type = a.NodeType.SelectorCombinatorSibling), this.finish(e)
              );
            }
            if (this.peekDelim('~')) {
              e = this.create(a.Node);
          ...
          (e.prototype._parseSimpleSelectorBody = function() {
            return (
              this._parsePseudo() || this._parseHash() || this._parseClass() || this._parseAttrib()
            );
          }),
          ...
          (e.prototype._parseHash = function() {
            if (!this.peek(s.TokenType.Hash) && !this.peekDelim('#')) return null;
            ...
            return (
              ...
              e.setIdentifier(this._parseIdent())
                ? (e.setOperator(this._parseOperator()) &&
                    (e.setValue(this._parseBinaryExpr()), this.acceptIdent('i')),
                ...
                if (
                  (e.addChild(
                    this.try(function() {
                      ...
                      for (; t.accept(s.TokenType.Comma) && e.addChild(t._parseSelector(!1)); );
                      return t.peek(s.TokenType.ParenthesisR) ? t.finish(e) : void 0;
          ...
          (e.prototype._parsePrio = function() {
            ...
            return this.accept(s.TokenType.Exclamation) && this.acceptIdent('important')
              ? this.finish(e)
              : null;
          }),
          ...
          (e.prototype._parseBinaryExpr = function(e, t) {
            ...
            if (!n.setRight(this._parseTerm())) return this.finish(n, l.ParseError.TermExpected);
            n = this.finish(n);
          ...
          (e.prototype._parseStringLiteral = function() {
            if (!this.peek(s.TokenType.String) && !this.peek(s.TokenType.BadString)) return null;
            var e = this.createNode(a.NodeType.StringLiteral);
            return this.consumeToken(), this.finish(e);
          }),
          (e.prototype._parseURILiteral = function() {
            if (!this.peekRegExp(s.TokenType.Ident, /^url(-prefix)?$/i)) return null;
            var e = this.mark(),
          ...
          (e.prototype._parseFunction = function() {
            ...
            if (t.getArguments().addChild(this._parseFunctionArgument()))
              for (; this.accept(s.TokenType.Comma) && !this.peek(s.TokenType.ParenthesisR); )
          ...
          (e.prototype._parseFunctionIdentifier = function() {
            ...
            if (((e.referenceTypes = [a.ReferenceType.Function]), this.acceptIdent('progid'))) {
              if (this.accept(s.TokenType.Colon))
                for (; this.accept(s.TokenType.Ident) && this.acceptDelim('.'); );
              return this.finish(e);
            }
            return this.consumeToken(), this.finish(e);
          }),
    ...
    i = (function() {
      ...
      return (
        ...
        (e.prototype.findInScope = function(e, t) {
          ...
          return r.offset <= e && r.offset + r.length >= e + t ? r.findInScope(e, t) : this;
        }),
  ...
  var r = (function() {
    ...
    return (
      ...
      (e.prototype.visitNode = function(e) {
        switch (e.type) {
          case d.NodeType.Keyframe:
            return this.addSymbol(e, e.getName(), void 0, d.ReferenceType.Keyframe), !0;
          ...
          case d.NodeType.MixinDeclaration:
            return this.addSymbol(e, e.getName(), void 0, d.ReferenceType.Mixin), !0;
          case d.NodeType.FunctionDeclaration:
            return this.addSymbol(e, e.getName(), void 0, d.ReferenceType.Function), !0;
          ...
          case d.NodeType.Each:
            var i = e,
              r = i.getDeclarations();
            if (r)
              for (var o = 0, s = i.getVariables().getChildren(); o < s.length; o++) {
                var a = s[o];
                this.addSymbolToChildScope(r, a, a.getName(), void 0, d.ReferenceType.Variable);
              }
            return !0;
        }
        return !0;
      ...
      (e.prototype.visitRuleSet = function(e) {
        var t = this.scope.findScope(e.offset, e.length);
        if (t)
          for (var n = 0, i = e.getSelectors().getChildren(); n < i.length; n++) {
            var r = i[n];
            r instanceof d.Selector &&
              1 === r.getChildren().length &&
              t.addSymbol(new s(r.getChild(0).getText(), void 0, r, d.ReferenceType.Rule));
          }
        return !0;
      }),
      ...
      (e.prototype.visitFunctionParameterNode = function(e) {
        ...
        if (t) {
          ...
          this.addSymbolToChildScope(t, e, e.getName(), i, d.ReferenceType.Variable);
        }
        return !0;
      }),
    ...
    return (
      ...
      (e.prototype.internalFindSymbol = function(e, t) {
        ...
        if (
          ...
          e.parent instanceof d.FunctionArgument && e.parent.getParent() instanceof d.Function)
        ) {
  ...
  (function(e) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.getLimitedString = function(e, t) {
        return (
          void 0 === t && (t = !0), e ? (e.length < 140 ? e : e.slice(0, 140) + (t ? '…' : '')) : ''
        );
      });
  }),
  (function(e) {
    ...
    'use strict';
    var s, n, i, r, o, a, l, c, d, p, h, m, u, f, g, b, y, v, w, x, k, S, T, C, F, E, I, P, _, A, D;
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (n.is = function(e) {
        var t = e;
        return se.objectLiteral(t) && se.number(t.line) && se.number(t.character);
      }),
      ((r = i = t.Range || (t.Range = {})).create = function(e, t, n, i) {
        ...
        throw new Error(
          'Range#create called with invalid arguments[' + e + ', ' + t + ', ' + n + ', ' + i + ']'
        );
      }),
      (r.is = function(e) {
        var t = e;
      ...
      (a.is = function(e) {
        var t = e;
        return se.defined(t) && i.is(t.range) && (se.string(t.uri) || se.undefined(t.uri));
      }),
      ((l = t.LocationLink || (t.LocationLink = {})).create = function(e, t, n, i) {
      ...
      (l.is = function(e) {
        ...
        return (
          ...
          (i.is(t.targetSelectionRange) || se.undefined(t.targetSelectionRange)) &&
      ...
      (d.is = function(e) {
        var t = e;
        return se.number(t.red) && se.number(t.green) && se.number(t.blue) && se.number(t.alpha);
      }),
      ((p = t.ColorInformation || (t.ColorInformation = {})).create = function(e, t) {
      ...
      ((h = t.ColorPresentation || (t.ColorPresentation = {})).create = function(e, t, n) {
      ...
      (h.is = function(e) {
        ...
        return (
          ...
          (se.undefined(t.additionalTextEdits) || se.typedArray(t.additionalTextEdits, k.is))
        );
      }),
      ((m = t.FoldingRangeKind || (t.FoldingRangeKind = {})).Comment = 'comment'),
      (m.Imports = 'imports'),
      (m.Region = 'region'),
      ((u = t.FoldingRange || (t.FoldingRange = {})).create = function(e, t, n, i, r) {
      ...
      (b.Information = 3),
      (b.Hint = 4),
      ((v = y = t.Diagnostic || (t.Diagnostic = {})).create = function(e, t, n, i, r, o) {
      ...
      (v.is = function(e) {
        ...
        return (
          ...
          (se.undefined(t.relatedInformation) || se.typedArray(t.relatedInformation, f.is))
        );
      }),
      ...
      ((C = T = t.TextDocumentEdit || (t.TextDocumentEdit = {})).create = function(e, t) {
      ...
      (E.is = function(e) {
        ...
        return (
          ...
          se.string(t.uri) &&
          (void 0 === t.options ||
            ((void 0 === t.options.overwrite || se.boolean(t.options.overwrite)) &&
              (void 0 === t.options.ignoreIfExists || se.boolean(t.options.ignoreIfExists))))
        );
      }),
      ((P = I = t.RenameFile || (t.RenameFile = {})).create = function(e, t, n) {
      ...
      (A.is = function(e) {
        ...
        return (
          ...
          se.string(t.uri) &&
          (void 0 === t.options ||
            ((void 0 === t.options.recursive || se.boolean(t.options.recursive)) &&
              (void 0 === t.options.ignoreIfNotExists || se.boolean(t.options.ignoreIfNotExists))))
        );
      }),
        ...
        return (
          ...
          (void 0 === t.documentChanges ||
            t.documentChanges.every(function(e) {
              return se.string(e.kind) ? F.is(e) || I.is(e) || _.is(e) : T.is(e);
            }))
        );
      });
    var z,
        ...
        return (
          ...
          (e.prototype.getTextEditChange = function(e) {
            ...
            if (!(i = this._textEditChanges[e])) {
              var r = [];
              (this._workspaceEdit.changes[e] = r), (i = new G(r)), (this._textEditChanges[e] = i);
            }
            return i;
          }),
          (e.prototype.createFile = function(e, t) {
            this.checkDocumentChanges(), this._workspaceEdit.documentChanges.push(F.create(e, t));
          }),
    ...
    (t.WorkspaceChange = H),
      ((z = t.TextDocumentIdentifier || (t.TextDocumentIdentifier = {})).create = function(e) {
        return { uri: e };
      }),
      (z.is = function(e) {
        var t = e;
      ...
      (O.is = function(e) {
        var t = e;
        return se.defined(t) && se.string(t.uri) && (null === t.version || se.number(t.version));
      }),
      ((N = t.TextDocumentItem || (t.TextDocumentItem = {})).create = function(e, t, n, i) {
      ...
      ((q = K = t.MarkedString || (t.MarkedString = {})).fromPlainText = function(e) {
        return e.replace(/[\\`*_{}[\]()#+\-.!]/g, '\\$&');
      }),
      (q.is = function(e) {
        var t = e;
        return se.string(t) || (se.objectLiteral(t) && se.string(t.language) && se.string(t.value));
      }),
      ((t.Hover || (t.Hover = {})).is = function(e) {
        ...
        return (
          !!t &&
          se.objectLiteral(t) &&
          (j.is(t.contents) || K.is(t.contents) || se.typedArray(t.contents, K.is)) &&
      ...
      (W.Operator = 25),
      (W.TypeParameter = 26),
      ((t.SymbolInformation || (t.SymbolInformation = {})).create = function(e, t, n, i, r) {
    ...
    var J,
      ...
      te = function() {};
    (t.DocumentSymbol = te),
      ((J = te = t.DocumentSymbol || (t.DocumentSymbol = {})).create = function(e, t, n, i, r, o) {
      ...
      ((Y = t.CodeActionContext || (t.CodeActionContext = {})).create = function(e, t) {
        var n = { diagnostics: e };
      ...
      ((Q = t.CodeAction || (t.CodeAction = {})).create = function(e, t, n) {
        var i = { title: e };
        return w.is(t) ? (i.command = t) : (i.edit = t), void 0 !== n && (i.kind = n), i;
      }),
      (Q.is = function(e) {
        var t = e;
        return (
      ...
      (Z.is = function(e) {
        var t = e;
        return se.defined(t) && i.is(t.range) && (se.undefined(t.command) || w.is(t.command));
      }),
      ...
      (ee.is = function(e) {
        var t = e;
        return se.defined(t) && se.number(t.tabSize) && se.boolean(t.insertSpaces);
      });
    var ne,
      ie,
      re,
      oe = function() {};
    (t.DocumentLink = oe),
      ((ne = oe = t.DocumentLink || (t.DocumentLink = {})).create = function(e, t, n) {
        return { range: e, target: t, data: n };
      }),
      (ne.is = function(e) {
        var t = e;
        return se.defined(t) && i.is(t.range) && (se.undefined(t.target) || se.string(t.target));
      }),
      (t.DocumentLink = oe),
      (t.EOL = ['\n', '\r\n', '\r']),
      ((ie = t.TextDocument || (t.TextDocument = {})).create = function(e, t, n, i) {
      ...
      (ie.applyEdits = function(e, t) {
        for (
          ...
          (n = n.substring(0, a) + s.newText + n.substring(l, n.length)), (r = a);
        }
        return n;
      }),
      ((re = t.TextDocumentSaveReason || (t.TextDocumentSaveReason = {})).Manual = 1),
      (re.AfterDelay = 2),
      (re.FocusOut = 3);
    var se,
      ae,
      ...
      i = (function() {
        ...
        return (
          (e.prototype.getSymbolContext = function() {
            return (
              this.symbolContext || (this.symbolContext = new n.Symbols(this.styleSheet)),
              this.symbolContext
            );
          }),
            ...
            try {
              ...
              for (var r = this.nodePath.length - 1; 0 <= r; r--) {
                ...
                if (o instanceof m.Property)
                  ...
                  var s = o.findAParent(m.NodeType.ExtendsReference, m.NodeType.Ruleset);
                  if (s)
                ...
                else if (o instanceof m.Declarations) this.getCompletionsForDeclarations(o, i);
                else if (o instanceof m.VariableDeclaration)
                  this.getCompletionsForVariableDeclaration(o, i);
                else if (o instanceof m.RuleSet) this.getCompletionsForRuleSet(o, i);
                else if (o instanceof m.Interpolation) this.getCompletionsForInterpolation(o, i);
                else if (o instanceof m.FunctionDeclaration)
                  this.getCompletionsForFunctionDeclaration(o, i);
                else if (o instanceof m.MixinReference) this.getCompletionsForMixinReference(o, i);
                else if (o instanceof m.Function)
                  this.getCompletionsForFunctionArgument(null, o, i);
                else if (o instanceof m.Supports) this.getCompletionsForSupports(o, i);
                ...
                else if (o.type === m.NodeType.StringLiteral && o.parent.type === m.NodeType.Import)
                  this.getCompletionForImportPath(o, i);
                else {
                  if (null !== o.parent) continue;
                  this.getCompletionForTopLevel(i);
                }
                if (0 < i.items.length || this.offset > o.offset) return this.finalize(i);
              }
              return (
            ...
            return (
              u.cssDataManager.getProperties().forEach(function(e) {
                ...
                o
                  ...
                  : ((t = a.getCompletionRange(null)), (n = e.name + ': '), (i = !0));
                var r = {
                  label: e.name,
                ...
                e.restrictions || (i = !1),
                  i && (r.command = { title: 'Suggest', command: 'editor.action.triggerSuggest' }),
                  f.startsWith(e.name, '-') && (r.sortText = 'x'),
                  s.items.push(r);
              }),
              this.completionParticipants.forEach(function(e) {
                e.onCssProperty &&
                  e.onCssProperty({ propertyName: a.currentWord, range: a.defaultReplaceRange });
              }),
              s
            );
          }),
          (e.prototype.getCompletionsForDeclarationValue = function(e, t) {
            ...
            return this.getVariableProposals(o, t), this.getTermProposals(r, o, t), t;
          }),
            ...
            for (
              ...
              if (r.node.type === m.NodeType.FunctionParameter) {
                ...
                a.type === m.NodeType.MixinDeclaration &&
                  (s.detail = l('completion.argument', "argument from '{0}'", a.getName()));
              }
              t.items.push(s);
            }
            return t;
          ...
          (e.prototype.getVariableProposalsForCSSVarFunction = function(e) {
            for (
              ...
              e.items.push({
                label: r.name,
                documentation: r.value ? f.getLimitedString(r.value) : r.value,
                textEdit: g.TextEdit.replace(this.getCompletionRange(null), r.name),
                kind: g.CompletionItemKind.Variable,
              });
            }
            return e;
          ...
          (e.prototype.getUnitProposals = function(e, t, n) {
            ...
            if (0 < this.currentWord.length) {
              ...
              r && ((i = r[0]), (n.isIncomplete = i.length === this.currentWord.length));
            } else 0 === this.currentWord.length && (n.isIncomplete = !0);
            if (
              (t && t.parent && t.parent.type === m.NodeType.Term && (t = t.getParent()),
              e.restrictions)
            )
              for (var o = 0, s = e.restrictions; o < s.length; o++) {
                ...
                if (l)
                  for (var c = 0, d = l; c < d.length; c++) {
                    ...
                    n.items.push({
                      label: p,
                      textEdit: g.TextEdit.replace(this.getCompletionRange(t), p),
          ...
          (e.prototype.getCompletionForTopLevel = function(t) {
            ...
            return (
              u.cssDataManager.getAtDirectives().forEach(function(e) {
                t.items.push({
                  label: e.name,
                  textEdit: g.TextEdit.replace(n.getCompletionRange(null), e.name),
                  documentation: u.getEntryDescription(e),
          ...
          (e.prototype.getCompletionsForSelector = function(e, t, i) {
            ...
            if (
              ...
              u.cssDataManager.getPseudoClasses().forEach(function(e) {
                ...
                f.startsWith(e.name, ':-') && (n.sortText = 'x'), i.items.push(n);
              }),
          ...
          (e.prototype.getCompletionsForDeclarations = function(e, t) {
            ...
            if (n instanceof m.AbstractDeclaration) {
              ...
              if (i instanceof m.Declaration) return this.getCompletionsForDeclarationValue(i, t);
            } else
          ...
          (e.prototype.getCompletionsForMixinReference = function(e, t) {
            for (
              var n = 0,
                i = this.getSymbolContext().findSymbolsAtOffset(this.offset, m.ReferenceType.Mixin);
              n < i.length;
              n++
            ) {
              var r = i[n];
              r.node instanceof m.MixinDeclaration &&
                t.items.push(this.makeTermProposal(r, r.node.getParameters(), null));
            }
            return t;
          }),
          ...
          (e.prototype.makeTermProposal = function(e, t, n) {
            ...
            var i = t.getChildren().map(function(e) {
                return e instanceof m.FunctionParameter ? e.getName() : e.getText();
              }),
              r =
                e.name +
                '(' +
          ...
          (e.prototype.getCompletionForUriLiteralValue = function(e, t) {
            ...
            if (0 === e.getChildren().length) {
              ...
              var s = e.getChild(0);
              (n = s.getText()), (i = this.position), (r = this.getCompletionRange(s));
            }
            return (
              this.completionParticipants.forEach(function(e) {
                e.onCssURILiteralValue &&
                  e.onCssURILiteralValue({ uriValue: n, position: i, range: r });
              }),
              t
            );
          }),
...
!(function(e) {
    ...
    g = (function() {
      ...
      return (
        ...
        (s.prototype.clone = function(e) {
          ...
          if (e && this.children) {
            t.children = [];
            for (var o = 0; o < this.children.length; o++) t.addChild(this.children[o].clone());
          }
          return t;
        }),
        (s.prototype.cloneWithParent = function() {
          var e = this.clone(!1);
          !this.parent || this.parent instanceof c || this.parent.cloneWithParent().addChild(e);
          return e;
        }),
        s
      );
      ...
      return (
        ...
        (e.prototype.doPrint = function(e, t) {
          for (var n = 0, i = e; n < i.length; n++) {
            var r = i[n];
            this.doPrintElement(r, t), r.children && this.doPrint(r.children, t + 1);
          }
        }),
      ...
      (e.prototype.processSelector = function(e) {
        ...
        if (
          ...
          e.getChildren().some(function(e) {
            return e.hasChildren() && e.getChild(0).type === f.NodeType.SelectorCombinator;
          })
        ) {
      ...
      n = (function() {
        ...
        return (
          (e.prototype.doHover = function(t, e, n) {
            function i(e) {
              return u.Range.create(t.positionAt(e.offset), t.positionAt(e.end));
            }
            for (var r = t.offsetAt(e), o = h.getNodePath(n, r), s = 0; s < o.length; s++) {
              var a = o[s];
              if (a instanceof h.Selector)
                return { contents: f.selectorToMarkedString(a), range: i(a) };
              if (a instanceof h.SimpleSelector)
                return { contents: f.simpleSelectorToMarkedString(a), range: i(a) };
              if (a instanceof h.Declaration) {
                var l = a.getFullPropertyName(),
                  c = m.cssDataManager.getProperty(l);
                if (c) {
                  var d = [];
                  c.description && d.push(u.MarkedString.fromPlainText(c.description));
  ...
  (function(e) {
        ...
        return (
          ...
          (e.prototype.findDocumentHighlights = function(t, e, n) {
            var i = [],
              r = t.offsetAt(e),
              o = c.getNodeAtOffset(n, r);
            if (!o || o.type === c.NodeType.Stylesheet || o.type === c.NodeType.Declarations)
              return i;
            ...
            return (
              n.accept(function(e) {
                if (a) {
                  if (s.matchesSymbol(e, a)) return i.push({ kind: u(e), range: m(e, t) }), !1;
            ...
            return (
              e.accept(function(e) {
                ...
                if (e.parent && e.parent.type === c.NodeType.Import) {
                  var n = e.getText();
                  return (s.startsWith(n, "'") || s.startsWith(n, '"')) && o.push(a(i, e, r)), !1;
                }
                return !0;
              }),
              o
          ...
          (e.prototype.findDocumentSymbols = function(i, e) {
            ...
            return (
              e.accept(function(e) {
                var t = { name: null, kind: d.SymbolKind.Class, location: null },
                  n = e;
                return e instanceof c.Selector
                  ? ((t.name = e.getText()),
                    (n = e.findAParent(c.NodeType.Ruleset, c.NodeType.ExtendsReference)) &&
                      ((t.location = d.Location.create(i.uri, m(n, i))), r.push(t)),
                    !1)
                  : (e instanceof c.VariableDeclaration
                      ? ((t.name = e.getName()), (t.kind = d.SymbolKind.Variable))
                      : e instanceof c.MixinDeclaration
                      ? ((t.name = e.getName()), (t.kind = d.SymbolKind.Method))
                      : e instanceof c.FunctionDeclaration
                      ? ((t.name = e.getName()), (t.kind = d.SymbolKind.Function))
                      : e instanceof c.Keyframe
                      ? (t.name = o('literal.keyframes', '@keyframes {0}', e.getName()))
                      : e instanceof c.FontFace && (t.name = o('literal.fontface', '@font-face')),
                    t.name && ((t.location = d.Location.create(i.uri, m(n, i))), r.push(t)),
                    !0);
              }),
              r
            );
    ...
    function a(e, t, n) {
      ...
      return r.start.line === r.end.line && r.start.character === r.end.character
        ? null
        : ((s.startsWith(i, "'") || s.startsWith(i, '"')) && (i = i.slice(1, -1)),
          {
            range: r,
            target:
              s.startsWith(i, 'http://') || s.startsWith(i, 'https://')
                ...
                ? s.endsWith(i, '.css') ||
                  ...
                  : n.resolveReference(i, e.uri).replace(/\/(\w+)(.scss)?$/gm, function(e, t) {
                      return '/_' + t + '.scss';
                    })
                : n.resolveReference(i, e.uri),
          });
    ...
    (t.Setting = l),
      (t.Rules = {
        ...
        DuplicateDeclarations: new a(
          'duplicateProperties',
          i('rule.duplicateDeclarations', 'Do not use duplicate style definitions'),
          s
        ),
        EmptyRuleSet: new a('emptyRules', i('rule.emptyRuleSets', 'Do not use empty rulesets'), r),
        ImportStatemement: new a(
          'importStatement',
          i('rule.importDirective', 'Import statements do not load in parallel'),
          s
        ),
        BewareOfBoxModelSize: new a(
          'boxModel',
          i('rule.bewareOfBoxModelSize', 'Do not use width or height when using padding or border'),
          s
        ),
        UniversalSelector: new a(
          'universalSelector',
          i('rule.universalSelector', 'The universal selector (*) is known to be slow'),
          s
        ),
        ZeroWithUnit: new a('zeroUnits', i('rule.zeroWidthUnit', 'No unit for zero needed'), s),
        ...
        HexColorLength: new a(
          'hexColorLength',
          i('rule.hexColor', 'Hex colors must consist of three, four, six or eight hex numbers'),
          o
        ),
        ...
        UnknownAtRules: new a('unknownAtRules', i('rule.unknownAtRules', 'Unknown at-rule.'), r),
        IEStarHack: new a(
          'ieHack',
          i('rule.ieHack', 'IE hacks are only necessary when supporting IE7 and older'),
          s
        ),
        UnknownVendorSpecificProperty: new a(
          'unknownVendorSpecificProperties',
          i('rule.unknownVendorSpecificProperty', 'Unknown vendor specific property.'),
          s
        ),
        PropertyIgnoredDueToDisplay: new a(
          'propertyIgnoredDueToDisplay',
          i('rule.propertyIgnoredDueToDisplay', 'Property is ignored due to the display.'),
          r
        ),
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-css-languageservice/services/lintUtil', [
          'require',
          'exports',
          '../utils/arrays',
        ], e);
    ...
    function h(e, t) {
      return (
        void 0 === t && (t = !0),
        !o.includes(['none', 'hidden'], e) && (!t || !o.includes(['initial', 'unset'], e))
      );
    }
    function m(e, t) {
      return (
      ...
      n = (function() {
        ...
        return (
          ...
          (J.prototype.findValueInExpression = function(e, t) {
            ...
            return (
              e.accept(function(e) {
                return e.type === Q.NodeType.Identifier && e.getText() === t && (n = !0), !n;
              }),
              n
            );
          }),
          ...
          (J.prototype.visitUnknownAtRule = function(e) {
            ...
            return (
              !!t &&
              (this.addEntry(t, Y.Rules.UnknownAtRules, 'Unknown at rule ' + t.getText()), !0)
            );
          }),
          ...
          (J.prototype.validateKeyframes = function() {
            ...
            for (var t in this.keyframes.data) {
              ...
              if (i || 1 !== n.length) {
                ...
                if (r || i)
                  for (var o = 0, s = this.keyframes.data[t].nodes; o < s.length; o++) {
                    var a = s[o];
                    if (i) {
                      var l = te(
                      ...
                      this.addEntry(a, Y.Rules.IncludeStandardPropertyWhenUsingVendorPrefix, l);
                    }
                    if (r) {
                      l = te(
          ...
          (J.prototype.visitSimpleSelector = function(e) {
            ...
            return (
              1 === e.length && '*' === t && this.addEntry(e, Y.Rules.UniversalSelector),
          ...
          (J.prototype.visitRuleSet = function(e) {
            ...
            if (!t) return !1;
            t.hasChildren() || this.addEntry(e.getSelectors(), Y.Rules.EmptyRuleSet);
            ...
            if (0 < m.length)
              for (
                var u = 0, f = ['width', 'height', 'margin-top', 'margin-bottom', 'float'];
                u < f.length;
                u++
              )
                for (var g = f[u], b = this.fetch(n, g), y = 0; y < b.length; y++) {
                  var v = b[y].node,
                    w = v.getValue();
            ...
            if (0 < (m = this.fetchWithValue(n, 'display', 'inline-block')).length)
            ...
            if (0 < (m = this.fetchWithValue(n, 'display', 'block')).length)
              for (b = this.fetch(n, 'vertical-align'), y = 0; y < b.length; y++)
                this.addEntry(
                  b[y].node,
                  Y.Rules.PropertyIgnoredDueToDisplay,
                  te(
            ...
            for (y = 0; y < k.length; y++) {
              o = k[y].node;
              this.isValidPropertyDeclaration(o) || this.addEntry(o, Y.Rules.AvoidFloat);
            }
            for (var S = 0; S < n.length; S++) {
              var T;
              if ('background' !== (T = n[S]).name && !this.validProperties[T.name])
                if ((w = T.node.getValue()) && '-' !== this.documentText.charAt(w.offset)) {
            ...
            if (!(':export' === e.getSelectors().getText())) {
              for (var I = new ne(), P = !1, _ = 0, A = t.getChildren(); _ < A.length; _++) {
                var D = A[_];
                  ...
                  if ('-' === R) {
                    if ('-' !== z.charAt(1)) {
                      X.cssDataManager.isKnownProperty(z) ||
                        ...
                        this.addEntry(o.getProperty(), Y.Rules.UnknownVendorSpecificProperty);
                    ...
                    var N = z;
                    ('*' !== R && '_' !== R) ||
                      (this.addEntry(o.getProperty(), Y.Rules.IEStarHack), (z = z.substr(1))),
                      X.cssDataManager.isKnownProperty(N) ||
                        ...
                        this.addEntry(
                          ...
                          te('property.unknownproperty.detailed', "Unknown property: '{0}'", z)
                        ),
                      I.add(z, z, null);
                  }
                } else P = !0;
              ...
              if (!P)
                for (var U in I.data) {
                  var M = I.data[U],
                    L = M.names,
                    j = X.cssDataManager.isStandardProperty(U) && -1 === L.indexOf(U);
                  if (j || 1 !== L.length) {
                    for (var V = [], B = ((S = 0), J.prefixes.length); S < B; S++) {
                      var K = J.prefixes[S];
                      X.cssDataManager.isStandardProperty(K + U) && V.push(K + U);
                    }
                    ...
                    if (q || j)
                      for (var $ = 0, W = M.nodes; $ < W.length; $++) {
                        ...
                        if (j) {
                          ...
                          this.addEntry(G, Y.Rules.IncludeStandardPropertyWhenUsingVendorPrefix, H);
                        }
                        if (q) {
                          H = te(
          ...
          (J.prototype.visitNumericValue = function(e) {
            ...
            if (n && n.getValue()) {
              var i = e.getValue();
              if (!i.unit || -1 === X.units.length.indexOf(i.unit.toLowerCase())) return !0;
          ...
          (J.prototype.visitFontFace = function(e) {
            var t = e.getDeclarations();
            if (t) {
              for (var n = !1, i = !1, r = !1, o = 0, s = t.getChildren(); o < s.length; o++) {
                var a = s[o];
              ...
              return r || (n && i) || this.addEntry(e, Y.Rules.RequiredPropertiesForFontFace), !0;
            }
          }),
          ...
          (J.prototype.visitHexColorValue = function(e) {
            var t = e.length;
            return (
              9 !== t && 7 !== t && 5 !== t && 4 !== t && this.addEntry(e, Y.Rules.HexColorLength),
              !1
            );
          }),
      ...
      n = (function() {
        ...
        return (
          ...
          (e.prototype.doValidation = function(i, e, t) {
            if ((void 0 === t && (t = this.settings), t && !1 === t.validate)) return [];
            var n = [];
            n.push.apply(n, s.ParseErrorCollector.entries(e)),
              n.push.apply(
                n,
                c.LintVisitor.entries(e, i, new l.LintConfigurationSettings(t && t.lint))
              );
            var r = [];
...
!(function(e) {
    ...
    return (
      ...
      (e.prototype.scanNext = function(e) {
        if (this.stream.advanceIfChar(l)) {
          var t = ['$'];
          if (this.ident(t)) return this.finishToken(e, i.VariableName, t.join(''));
          this.stream.goBackTo(e);
        }
  ...
  (function(e) {
    ...
    (t.SCSSIssueType = i),
      (t.SCSSParseError = {
        FromExpected: new i('scss-fromexpected', n('expected.from', "'from' expected")),
        ThroughOrToExpected: new i(
          'scss-throughexpected',
          n('expected.through', "'through' or 'to' expected")
        ),
        InExpected: new i('scss-fromexpected', n('expected.in', "'in' expected")),
      });
  });
__extends =
  (this && this.__extends) ||
    ...
    i = (function(i) {
      ...
      return (
        ...
        (e.prototype._parseVariableDeclaration = function(e) {
          if ((void 0 === e && (e = []), !this.peek(o.VariableName))) return null;
          var t = this.create(a.VariableDeclaration);
          if (!t.setVariable(this._parseVariable())) return null;
          if (!this.accept(s.TokenType.Colon)) return this.finish(t, l.ParseError.ColonExpected);
        ...
        (e.prototype._parseIdent = function(e) {
          ...
          (n.referenceTypes = e), (n.isCustomProperty = this.peekRegExp(s.TokenType.Ident, /^--/));
          for (
            var i, r = !1;
            (this.accept(s.TokenType.Ident) ||
              n.addChild(
                (void 0,
                (i = t.mark()),
                t.acceptDelim('-') && (t.hasWhitespace() || t.acceptDelim('-'), t.hasWhitespace())
        ...
        (e.prototype._parseDeclaration = function(e) {
          ...
          if (!this.accept(s.TokenType.Colon))
            return this.finish(t, l.ParseError.ColonExpected, [s.TokenType.Colon], e);
          t.colonPosition = this.prevToken.offset;
          var n = !1;
          if (
          ...
          else if (!n) return this.finish(t, l.ParseError.PropertyValueExpected);
          return (
            this.peek(s.TokenType.SemiColon) && (t.semicolonPosition = this.token.offset),
            this.finish(t)
          );
        ...
        (e.prototype._parseExtends = function() {
          if (this.peekKeyword('@extend')) {
            ...
            return this.accept(s.TokenType.Exclamation) && !this.acceptIdent('optional')
        ...
        (e.prototype._parseElementName = function() {
          ...
          return t && !this.hasWhitespace() && this.peek(s.TokenType.ParenthesisL)
            ? (this.restoreAtMark(e), null)
            : t;
        }),
        (e.prototype._tryParsePseudoIdentifier = function() {
          return this._parseInterpolation() || i.prototype._tryParsePseudoIdentifier.call(this);
        }),
              ...
              ? this.acceptIdent('from')
                ? t.addChild(this._parseBinaryExpr())
                  ? this.acceptIdent('to') || this.acceptIdent('through')
                    ? t.addChild(this._parseBinaryExpr())
                      ? this._parseBody(t, e)
                      : this.finish(t, l.ParseError.ExpressionExpected, [s.TokenType.CurlyR])
                    : this.finish(t, r.SCSSParseError.ThroughOrToExpected, [s.TokenType.CurlyR])
                  : this.finish(t, l.ParseError.ExpressionExpected, [s.TokenType.CurlyR])
                : this.finish(t, r.SCSSParseError.FromExpected, [s.TokenType.CurlyR])
              : this.finish(t, l.ParseError.VariableNameExpected, [s.TokenType.CurlyR])
          );
        }),
        (e.prototype._parseEachStatement = function(e) {
          ...
          if (!n.addChild(this._parseVariable()))
            return this.finish(t, l.ParseError.VariableNameExpected, [s.TokenType.CurlyR]);
          for (; this.accept(s.TokenType.Comma); )
            if (!n.addChild(this._parseVariable()))
              return this.finish(t, l.ParseError.VariableNameExpected, [s.TokenType.CurlyR]);
          return (
            ...
            this.acceptIdent('in')
              ? t.addChild(this._parseExpr())
                ? this._parseBody(t, e)
                : this.finish(t, l.ParseError.ExpressionExpected, [s.TokenType.CurlyR])
              : this.finish(t, r.SCSSParseError.InExpected, [s.TokenType.CurlyR])
          );
        }),
        ...
        (e.prototype._parseFunctionDeclaration = function() {
          ...
          if ((this.consumeToken(), !e.setIdentifier(this._parseIdent([a.ReferenceType.Function]))))
            return this.finish(e, l.ParseError.IdentifierExpected, [s.TokenType.CurlyR]);
          if (!this.accept(s.TokenType.ParenthesisL))
            return this.finish(e, l.ParseError.LeftParenthesisExpected, [s.TokenType.CurlyR]);
          ...
          return this.accept(s.TokenType.ParenthesisR)
            ...
            : this.finish(e, l.ParseError.RightParenthesisExpected, [s.TokenType.CurlyR]);
        }),
        ...
        (e.prototype._parseMixinDeclaration = function() {
          ...
          if ((this.consumeToken(), !e.setIdentifier(this._parseIdent([a.ReferenceType.Mixin]))))
            return this.finish(e, l.ParseError.IdentifierExpected, [s.TokenType.CurlyR]);
          if (this.accept(s.TokenType.ParenthesisL)) {
            if (e.getParameters().addChild(this._parseParameterDeclaration()))
              for (; this.accept(s.TokenType.Comma) && !this.peek(s.TokenType.ParenthesisR); )
                if (!e.getParameters().addChild(this._parseParameterDeclaration()))
                  return this.finish(e, l.ParseError.VariableNameExpected);
            if (!this.accept(s.TokenType.ParenthesisR))
              return this.finish(e, l.ParseError.RightParenthesisExpected, [s.TokenType.CurlyR]);
          }
          return this._parseBody(e, this._parseRuleSetDeclaration.bind(this));
        }),
        (e.prototype._parseParameterDeclaration = function() {
          ...
          return e.setIdentifier(this._parseVariable())
            ? (this.accept(o.Ellipsis),
              this.accept(s.TokenType.Colon) && !e.setDefaultValue(this._parseExpr(!0))
                ? this.finish(
                    e,
        ...
        (e.prototype._parseFunctionArgument = function() {
          ...
          return e.setValue(this._parseExpr(!0))
            ? (this.accept(o.Ellipsis), e.addChild(this._parsePrio()), this.finish(e))
            : null;
        }),
        (e.prototype._parseURLArgument = function() {
          var e = this.mark(),
    ...
    r = (function(r) {
      ...
      return (
        ...
        (o.prototype.createReplaceFunction = function() {
          var n = 1;
          return function(e, t) {
            return '\\' + t + ': ${' + n++ + ':' + (o.variableDefaults[t] || '') + '}';
          };
        }),
        ...
        (o.prototype.getCompletionsForExtendsReference = function(e, t, n) {
          for (
            var i = 0,
              r = this.getSymbolContext().findSymbolsAtOffset(this.offset, a.ReferenceType.Rule);
            i < r.length;
            i++
          ) {
            var o = r[i],
              s = {
                label: o.name,
                textEdit: c.TextEdit.replace(this.getCompletionRange(t), o.name),
                kind: c.CompletionItemKind.Function,
              };
            n.items.push(s);
          }
        ...
        (o.colorProposals = [
          ...
          {
            func: 'green($color)',
            desc: i('scss.builtin.green', 'Gets the green component of a color.'),
          },
          {
            func: 'blue($color)',
          ...
          },
          {
            ...
            desc: i('scss.builtin.saturation', 'Gets the saturation component of a color.'),
          },
          {
            func: 'lightness($color)',
            desc: i('scss.builtin.lightness', 'Gets the lightness component of a color.'),
          },
          {
          ...
          },
          {
            ...
            desc: i('scss.builtin.complement', 'Returns the complement of a color.'),
          },
          {
            func: 'invert($color)',
          ...
          {
            func: 'alpha($color)',
            desc: i('scss.builtin.alpha', 'Gets the opacity component of a color.'),
          },
          { func: 'opacity($color)', desc: 'Gets the alpha component (opacity) of a color.' },
          {
            func: 'rgba($color, $alpha)',
            desc: i('scss.builtin.rgba', 'Changes the alpha component for a color.'),
          },
          {
          ...
          },
          {
            ...
            desc: i('scss.builtin.transparentize', 'Makes a color more transparent.'),
          },
          {
          ...
          },
          {
            ...
            desc: i('scss.builtin.change-color', 'Changes one or more properties of a color.'),
          },
          {
        ...
        (o.builtInFuncs = [
          ...
          { func: 'quote($string)', desc: i('scss.builtin.quote', 'Adds quotes to a string.') },
          {
            func: 'str-length($string)',
            desc: i('scss.builtin.str-length', 'Returns the number of characters in a string.'),
          },
          {
            func: 'str-insert($string, $insert, $index)',
            desc: i('scss.builtin.str-insert', 'Inserts $insert into $string at $index.'),
          },
          {
          ...
          },
          {
            ...
            desc: i('scss.builtin.str-slice', 'Extracts a substring from $string.'),
          },
          {
            func: 'to-upper-case($string)',
            desc: i('scss.builtin.to-upper-case', 'Converts a string to upper case.'),
          },
          {
            func: 'to-lower-case($string)',
            desc: i('scss.builtin.to-lower-case', 'Converts a string to lower case.'),
          },
          {
            func: 'percentage($number)',
            desc: i('scss.builtin.percentage', 'Converts a unitless number to a percentage.'),
            type: 'percentage',
          },
          {
            func: 'round($number)',
            desc: i('scss.builtin.round', 'Rounds a number to the nearest whole number.'),
          },
          {
            func: 'ceil($number)',
            desc: i('scss.builtin.ceil', 'Rounds a number up to the next whole number.'),
          },
          {
            func: 'floor($number)',
            desc: i('scss.builtin.floor', 'Rounds a number down to the previous whole number.'),
          },
          {
            func: 'abs($number)',
            desc: i('scss.builtin.abs', 'Returns the absolute value of a number.'),
          },
          {
            func: 'min($numbers)',
            desc: i('scss.builtin.min', 'Finds the minimum of several numbers.'),
          },
          {
            func: 'max($numbers)',
            desc: i('scss.builtin.max', 'Finds the maximum of several numbers.'),
          },
          { func: 'random([$limit])', desc: i('scss.builtin.random', 'Returns a random number.') },
          {
            func: 'length($list)',
          ...
          },
          {
            ...
            desc: i('scss.builtin.append', 'Appends a single value onto the end of a list.'),
          },
          {
            func: 'zip($lists)',
            desc: i(
          ...
          },
          {
            ...
            desc: i('scss.builtin.index', 'Returns the position of a value within a list.'),
          },
          {
            func: 'list-separator(#list)',
            desc: i('scss.builtin.list-separator', 'Returns the separator of a list.'),
          },
          {
          ...
          },
          {
            ...
            desc: i('scss.builtin.map-merge', 'Merges two maps together into a new map.'),
          },
          {
            func: 'map-remove($map, $keys)',
            desc: i('scss.builtin.map-remove', 'Returns a new map with keys removed.'),
          },
          {
            func: 'map-keys($map)',
            desc: i('scss.builtin.map-keys', 'Returns a list of all keys in a map.'),
          },
          {
            func: 'map-values($map)',
            desc: i('scss.builtin.map-values', 'Returns a list of all values in a map.'),
          },
          {
          ...
          {
            func: 'unit($number)',
            desc: i('scss.builtin.unit', 'Returns the unit(s) associated with a number.'),
          },
          {
            func: 'unitless($number)',
            desc: i('scss.builtin.unitless', 'Returns whether a number has units.'),
          },
          {
        ...
        (o.scssAtDirectives = [
          {
            label: '@extend',
            documentation: i('scss.builtin.@extend', 'Inherits the styles of another selector.'),
      ...
      return (
        ...
        (e.prototype._parseImport = function() {
          ...
          if ((this.consumeToken(), this.accept(o.TokenType.ParenthesisL))) {
            if (!this.accept(o.TokenType.Ident))
              return this.finish(e, a.ParseError.IdentifierExpected, [o.TokenType.SemiColon]);
            do {
              if (!this.accept(o.TokenType.Comma)) break;
            } while (this.accept(o.TokenType.Ident));
            if (!this.accept(o.TokenType.ParenthesisR))
              return this.finish(e, a.ParseError.RightParenthesisExpected, [o.TokenType.SemiColon]);
          }
          return e.addChild(this._parseURILiteral()) || e.addChild(this._parseStringLiteral())
            ? (this.peek(o.TokenType.SemiColon) ||
                ...
                e.setMedialist(this._parseMediaQueryList()),
              this.finish(e))
            : this.finish(e, a.ParseError.URIOrStringExpected, [o.TokenType.SemiColon]);
        }),
        ...
        (e.prototype._parseVariableDeclaration = function(e) {
          ...
          if (
            ...
            return null;
          if (!this.accept(o.TokenType.Colon)) return this.restoreAtMark(n), null;
          if (((t.colonPosition = this.prevToken.offset), t.setValue(this._parseDetachedRuleSet())))
            t.needsSemicolon = !1;
          else if (!t.setValue(this._parseExpr()))
            return this.finish(t, a.ParseError.VariableValueExpected, [], e);
          return (
            t.addChild(this._parsePrio()),
            this.peek(o.TokenType.SemiColon) && (t.semicolonPosition = this.token.offset),
            this.finish(t)
          );
        }),
        ...
        (e.prototype._parseVariable = function() {
          if (!this.peekDelim('@') && !this.peekDelim('$') && !this.peek(o.TokenType.AtKeyword))
            return null;
          for (
          ...
          return this.accept(o.TokenType.AtKeyword) || this.accept(o.TokenType.Ident)
            ? e
            : (this.restoreAtMark(t), null);
        }),
        (e.prototype._parseTerm = function() {
        ...
        (e.prototype._parseEscaped = function() {
          ...
          if (this.peekDelim('~')) {
            ...
            return (
              this.consumeToken(),
              this.accept(o.TokenType.String) || this.accept(o.TokenType.EscapedJavaScript)
                ? this.finish(e)
        ...
        (e.prototype._parseKeyframeIdent = function() {
          return this._parseIdent([s.ReferenceType.Keyframe]) || this._parseVariable();
        }),
        (e.prototype._parseKeyframeSelector = function() {
          return this._parseDetachedRuleSetMixin() || i.prototype._parseKeyframeSelector.call(this);
        }),
        (e.prototype._parseSimpleSelectorBody = function() {
          return this._parseSelectorCombinator() || i.prototype._parseSimpleSelectorBody.call(this);
        }),
        (e.prototype._parseSelector = function(e) {
          ...
          for (
            ...
            n = !0;
            var i = this.mark();
            if (t.addChild(this._parseGuard()) && this.peek(o.TokenType.CurlyL)) break;
          ...
          for (
            ...
            (this.accept(o.TokenType.Ident) ||
              e.addChild(
                (void 0,
                (t = n.mark()),
                n.acceptDelim('-') && (n.hasWhitespace() || n.acceptDelim('-'), n.hasWhitespace())
        ...
        (e.prototype._tryParseMixinDeclaration = function() {
          ...
          if (t.getParameters().addChild(this._parseMixinParameter()))
            for (
              ;
              (this.accept(o.TokenType.Comma) || this.accept(o.TokenType.SemiColon)) &&
              !this.peek(o.TokenType.ParenthesisR);

            )
              t.getParameters().addChild(this._parseMixinParameter()) ||
                this.markError(t, a.ParseError.IdentifierExpected, [], [o.TokenType.ParenthesisR]);
        ...
        (e.prototype._parseExtend = function() {
          ...
          return (
            this.consumeToken(),
            !this.hasWhitespace() && this.accept(o.TokenType.Colon) && this.acceptIdent('extend')
              ? this._completeExtends(t)
              : (this.restoreAtMark(e), null)
          );
        }),
        ...
        (e.prototype._tryParseMixinReference = function() {
          ...
          if (!this.hasWhitespace() && this.accept(o.TokenType.ParenthesisL)) {
            if (((r = !0), t.getArguments().addChild(this._parseMixinArgument())))
              for (
                ;
                (this.accept(o.TokenType.Comma) || this.accept(o.TokenType.SemiColon)) &&
                !this.peek(o.TokenType.ParenthesisR);
          ...
          } else n.referenceTypes = [s.ReferenceType.Mixin, s.ReferenceType.Rule];
          return (
            t.addChild(this._parsePrio()),
            r ||
            this.peek(o.TokenType.SemiColon) ||
        ...
        (e.prototype._parseMixinArgument = function() {
          var e = this.create(s.FunctionArgument),
            ...
            n = this._parseVariable();
          return (
            n && (this.accept(o.TokenType.Colon) ? e.setIdentifier(n) : this.restoreAtMark(t)),
        ...
        (e.prototype._parseMixinParameter = function() {
          ...
          var i = !1;
          return (
            e.setIdentifier(this._parseVariable()) && (this.accept(o.TokenType.Colon), (i = !0)),
            e.setDefaultValue(this._parseDetachedRuleSet() || this._parseExpr(!0)) || i
              ? this.finish(e)
              : null
          );
        }),
        ...
        (e.prototype._parseFunctionIdentifier = function() {
          if (this.peekDelim('%')) {
            var e = this.create(s.Identifier);
            return (
              (e.referenceTypes = [s.ReferenceType.Function]), this.consumeToken(), this.finish(e)
            );
          }
...
!(function(e) {
    ...
    r = (function(r) {
      ...
      return (
          ...
          for (var r = 0, o = e; r < o.length; r++) {
            var s = o[r],
              a = {
                ...
                textEdit: l.TextEdit.replace(this.getCompletionRange(t), s.name + '($0)'),
        ...
        (o.builtInProposals = [
          ...
          { name: 'pi', description: i('less.builtin.pi', 'returns pi'), example: 'pi();' },
          {
            name: 'pow',
            description: i(
              'less.builtin.pow',
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-css-languageservice/services/cssFolding', [
          'require',
          'exports',
          '../parser/cssScanner',
          '../parser/scssScanner',
                ...
                switch (g.type) {
                  ...
                  case b.TokenType.CurlyR:
                    if (0 !== m.length) {
                      ...
                      'brace' === e.type &&
                        (p(f) !== t && t--,
                        e.line !== t && h.push({ startLine: e.line, endLine: t, kind: void 0 }));
                    }
                    break;
                  case b.TokenType.Comment:
                    var i = function(e) {
                      ...
                      n = (function(e) {
                        var t = e.text.match(/^\s*\/\*\s*(#region|#endregion)\b\s*(.*?)\s*\*\//);
                        if (t) return i(t[1]);
                        if ('scss' === c.languageId || 'less' === c.languageId) {
                          var n = e.text.match(/^\s*\/\/\s*(#region|#endregion)\b\s*(.*?)\s*/);
                          if (n) return i(n[1]);
                        }
                        return null;
                      })(g);
                    if (n)
                      if (n.isStart) m.push(n);
                        ...
                        'comment' === e.type &&
                          e.line !== n.line &&
                          h.push({ startLine: e.line, endLine: n.line, kind: 'region' });
                      }
                    else {
                      var r = ((s = 'comment'),
                      (a = d((o = g))),
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-css-languageservice/cssLanguageTypes', [
          'require',
          'exports',
          'vscode-languageserver-types',
        ], e);
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-css-languageservice/services/cssSelectionRange', [
          'require',
          'exports',
          'vscode-languageserver-types',
          '../parser/cssNodes',
    ...
    t.getSelectionRanges = function(i, e, r) {
      return e.map(function(e) {
        return (function(e) {
          ...
          if (!t) return [];
          for (var n = []; t; )
            (t.parent && t.offset === t.parent.offset && t.end === t.parent.end) ||
  ...
  (function(e) {
    ...
    function b(e) {
      e && e.customDataProviders && u.cssDataManager.addDataProviders(e.customDataProviders);
    }
  ...
  define('vscode-css-languageservice', ['vscode-css-languageservice/cssLanguageService'], function(
    e
  ) {
    return e;
  }),
      ...
      return (
        ...
        (e.prototype._getTextDocument = function(e) {
          for (var t = 0, n = this._ctx.getMirrorModels(); t < n.length; t++) {
            var i = n[t];
            if (i.uri.toString() === e)
              return r.TextDocument.create(e, this._languageId, i.version, i.getValue());
          }
          return null;
        }),
        e
