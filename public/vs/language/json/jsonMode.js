...
define('vs/language/json/workerManager', ['require', 'exports'], function(e, t) {
  ...
  (function(e) {
        ...
        return (
          ...
          (e.prototype.renameFile = function(e, t, n) {
            this.checkDocumentChanges(),
              this._workspaceEdit.documentChanges.push(A.create(e, t, n));
          }),
    ...
    (t.WorkspaceChange = Y),
      ...
      ((t.SignatureInformation || (t.SignatureInformation = {})).create = function(e, t) {
        ...
        return (
          ...
          ae.defined(n) ? (o.parameters = n) : (o.parameters = []),
          o
        );
      }),
    ...
    (t.DocumentSymbol = te),
      ...
      (Q.is = function(e) {
        ...
        return (
          ae.defined(t) &&
          ae.typedArray(t.diagnostics, b.is) &&
  ...
  define('vs/language/json/languageFeatures', [
      ...
      n = (function() {
        function e(e, t, n) {
          ...
          this._disposables.push(monaco.editor.onDidCreateModel(o)),
            ...
            this._disposables.push({
              dispose: function() {
                for (var e in (monaco.editor.getModels().forEach(i), r._listener))
    ...
    function u(e) {
      if (e)
        return new s(e.start.line + 1, e.start.character + 1, e.end.line + 1, e.end.character + 1);
    }
    function f(e) {
              ...
              if (e) {
                var t = o.getWordUntilPosition(i),
                  ...
                  r = e.items.map(function(e) {
                    ...
                    return (
                      e.textEdit &&
                        ((t.range = u(e.textEdit.range)), (t.insertText = e.textEdit.newText)),
                      e.additionalTextEdits &&
                        (t.additionalTextEdits = e.additionalTextEdits.map(f)),
      ...
      (t.createScanner = function(i, e) {
        ...
        function t() {
          ...
          switch (e) {
            ...
            case 45:
              if (((s += String.fromCharCode(e)), ++a === o || !h(i.charCodeAt(a))))
                return (u = 16);
            case 48:
            case 49:
            case 50:
  ...
  (function(e) {
    ...
    (t.format = function(r, e, t) {
      ...
      for (; 17 !== y; ) {
        for (
          var C = g.getTokenOffset() + g.getTokenLength() + i, E = m(), _ = '';
          !d && (12 === E || 13 === E);
            ...
            return (function() {
              ...
              for (var e = !1; 2 !== o.getToken() && 17 !== o.getToken(); ) {
                ...
                (10 !== o.getToken()
                  ? (b(3, [], [2, 5]), 0)
                  : (y(!1),
                    6 === o.getToken() ? (l(':'), v(), k() || b(4, [], [2, 5])) : b(5, [], [2, 5]),
                    1)) || b(4, [], [2, 5]),
                  (e = !0);
              }
          ...
          e,
          {
            ...
            onObjectProperty: function(e, t, n) {
              (o = a({
                ...
                parent: o,
                children: [],
              })).children.push({ type: 'string', value: e, offset: t, length: n, parent: o });
            },
            onObjectEnd: function(e, t) {
  ...
  (function(e) {
    ...
    function r(e, t, n, r, o) {
      for (
        ...
        0 < a.length &&
        ((u = a.pop()), void 0 === (c = C.findNodeAtLocation(s, a)) && void 0 !== n);
      ...
      if (c) {
        if ('object' === c.type && 'string' == typeof u && Array.isArray(c.children)) {
          ...
          if (void 0 !== f) {
            if (void 0 !== n)
              return E(e, { offset: f.offset, length: f.length, content: JSON.stringify(n) }, r);
        ...
        if ('array' === c.type && 'number' == typeof u && Array.isArray(c.children)) {
          if (-1 === u) {
            ...
            if (0 === c.children.length) m = { offset: c.offset + 1, length: 0, content: p };
              ...
              m = {
                offset: (y = c.children[c.children.length - 1]).offset + y.length,
                length: 0,
                content: ',' + p,
              };
            return E(e, m, r);
      ...
      return E(
        e,
        { offset: s ? s.offset : 0, length: s ? s.length : 0, content: JSON.stringify(n) },
        r
      );
    }
    function E(e, t, n) {
  ...
  define('vs/language/json/tokenization', ['require', 'exports', 'jsonc-parser'], function(
    e,
    g,
    p
  ) {
      ...
      return (
        ...
        (t.prototype.equals = function(e) {
          return (
            e === this ||
            (!!(e && e instanceof t) &&
              (this.scanError === e.scanError && this.lastWasColon === e.lastWasColon))
          );
        }),
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.setupMode = function(e) {
        ...
        t.push(monaco.languages.registerCompletionItemProvider(o, new a.CompletionAdapter(r))),
          ...
          t.push(
            monaco.languages.registerDocumentSymbolProvider(o, new a.DocumentSymbolAdapter(r))
          ),
          t.push(
