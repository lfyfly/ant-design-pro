...
!(function(e) {
  ...
  var n = (function() {
    ...
    return (
      (n.prototype.record = function(n, o) {
        this._events.push(new t(n, o, e.Utilities.getHighPerformanceTimestamp()));
      }),
  ...
  var t = (function() {
    ...
    return (
      ...
      (t.recursiveClone = function(e) {
        ...
        return (
          t.forEachProperty(e, function(e, o) {
            n[e] = o && 'object' == typeof o ? t.recursiveClone(o) : o;
          }),
          n
        );
      }),
...
!(function(e) {
  var t = (function() {
    ...
    return (
            ...
            'function' != typeof t.nodeCachedData.onData &&
              (t.nodeCachedData.onData = function(e) {
                e && 'cachedDataRejected' === e.errorCode
                  ...
                  : e && e.errorCode
                  ? (console.error('Problems handling cached data file: ' + e.path),
                    console.error(e.detail))
                  : e && console.error(e);
              }),
      ...
      (t.mergeConfigurationOptions = function(n, o) {
        void 0 === n && (n = null), void 0 === o && (o = null);
        var r = e.Utilities.recursiveClone(o || {});
        return (
          ...
          t.validateConfigurationOptions(r)
        );
      }),
      t
    );
  ...
  var n = (function() {
    function n(e, n) {
      if (
        ...
        if (
          ...
          this.options.baseUrl = o.substring(0, r + 1);
        }
    ...
    return (
      ...
      (n.prototype._applyPaths = function(t) {
        for (var n, o = 0, r = this.sortedPathsRules.length; o < r; o++)
          if (((n = this.sortedPathsRules[o]), e.Utilities.startsWith(t, n.from))) {
            for (var i = [], s = 0, a = n.to.length; s < a; s++)
              i.push(n.to[s] + t.substr(n.from.length));
            return i;
          }
        return [t];
      }),
      ...
      (n.prototype.moduleIdToPaths = function(t) {
        ...
        var n,
          o = t;
        if (e.Utilities.endsWith(o, '.js') || e.Utilities.isAbsolutePath(o))
          e.Utilities.endsWith(o, '.js') || e.Utilities.containsQueryString(o) || (o += '.js'),
            (n = [o]);
        else
          for (var r = 0, i = (n = this._applyPaths(o)).length; r < i; r++)
        ...
        (e.prototype.load = function(e, t, i, s) {
          ...
          this._scriptLoader ||
            (this._scriptLoader = this._env.isWebWorker
              ...
              ? new r(this._env)
              : new n());
          var d = { callback: i, errorback: s };
          this._callbackMap.hasOwnProperty(t)
            ? this._callbackMap[t].push(d)
            : ((this._callbackMap[t] = [d]),
      ...
      return (
        ...
        (e.prototype.load = function(e, t, n, o) {
          ...
          r.setAttribute('async', 'async'),
            ...
            this.attachListeners(r, n, o),
            r.setAttribute('src', t);
          var i = e.getConfig().getOptionsLiteral().cspNonce;
          i && r.setAttribute('nonce', i), document.getElementsByTagName('head')[0].appendChild(r);
        }),
        e
      );
    })(),
      ...
      return (
        (t.prototype._init = function(e) {
          this._didInitialize ||
            ...
            (this._hasCreateCachedData =
              'function' == typeof new this._vm.Script('').createCachedData));
        }),
        (t.prototype._initNodeRequire = function(e, t) {
          ...
          if (n && !this._didPatchNodeRequire) {
            ...
            var o = this,
              r = e('module');
            r.prototype._compile = function(e, i) {
              e = e.replace(/^#!.*/, '');
              var s = r.wrap(e),
                a = o._getCachedDataPath(n.seed, n.path, i),
                d = { filename: i };
              try {
                d.cachedData = o._fs.readFileSync(a);
              } catch (e) {
                d.produceCachedData = !o._hasCreateCachedData;
              }
              var u = new o._vm.Script(s, d),
                l = u.runInThisContext(d),
                c = o._path.dirname(i),
                h = (function(e) {
                  var t = e.constructor,
                    n = function(t) {
                ...
                p = l.apply(this.exports, f);
              return o._processCachedData(t, u, s, a, !d.cachedData), p;
            };
          }
        }),
        (t.prototype.load = function(n, o, r, i) {
          var s = this,
          ...
          if (/^node\|/.test(o)) {
            ...
            (o = e.Utilities.fileUriToFilePath(this._env.isWindows, o)),
              this._fs.readFile(o, { encoding: 'utf8' }, function(e, d) {
                if (e) i(e);
                else {
                  var c = s._path.normalize(o),
                    h = c;
                  ...
                  if (
                    ((p =
                      d.charCodeAt(0) === t._BOM ? _ + d.substring(1) + '\n});' : _ + d + '\n});'),
                    (p = u(p, c)),
                    a.nodeCachedData)
                  ) {
                    var g = s._getCachedDataPath(a.nodeCachedData.seed, a.nodeCachedData.path, o);
                    s._fs.readFile(g, function(e, t) {
                      var a = {
                        ...
                        d = s._loadAndEvalScript(n, o, h, p, a, l, r, i);
                      s._processCachedData(n, d, p, g, !a.cachedData);
                    });
                  } else s._loadAndEvalScript(n, o, h, p, { filename: h }, l, r, i);
                }
              });
        }),
        (t.prototype._loadAndEvalScript = function(t, n, o, r, i, s, a, d) {
          s.record(31, n);
          var u = new this._vm.Script(r, i),
          ...
          return (
            (f.amd = c.amd),
            l.call(e.global, t.getGlobalAMDRequireFunc(), f, o, this._path.dirname(n)),
            s.record(32, n),
            h ? a() : d(new Error("Didn't receive define call in " + n + '!')),
            u
          );
        }),
        (t.prototype._getCachedDataPath = function(e, t, n) {
          var o = this._crypto
              ...
              .update(e, 'utf8')
              .digest('hex'),
            r = this._path.basename(n).replace(/\.js$/, '');
          return this._path.join(t, r + '-' + o + '.code');
        }),
        (t.prototype._processCachedData = function(e, n, o, r, i) {
          var s = this;
          n.cachedDataRejected
            ? (e
                .getConfig()
                .getOptionsLiteral()
                .nodeCachedData.onData({ errorCode: 'cachedDataRejected', path: r }),
              t._runSoon(function() {
                return s._fs.unlink(r, function(t) {
                  t &&
                    e
                      .getConfig()
                      .getOptionsLiteral()
                      .nodeCachedData.onData({ errorCode: 'unlink', path: r, detail: t });
                });
            ...
            ? (e
                .getConfig()
                .getOptionsLiteral()
                .nodeCachedData.onData(void 0, { path: r }),
              t._runSoon(function() {
                return s._fs.writeFile(r, n.cachedData, function(t) {
                  t &&
                    e
                      .getConfig()
                      .getOptionsLiteral()
                      .nodeCachedData.onData({ errorCode: 'writeFile', path: r, detail: t });
                });
            ...
            : this._hasCreateCachedData &&
              ...
              (e
                ...
                .nodeCachedData.onData(void 0, { path: r }),
              t._runSoon(function() {
                var t = n.createCachedData(o);
                s._fs.writeFile(r, t, function(t) {
                  t &&
                    e
                      .getConfig()
                      .getOptionsLiteral()
...
!(function(e) {
  var t = (function() {
    ...
    return (
      ...
      (t.prototype.resolveModule = function(n) {
        var o = n;
        return (
          e.Utilities.isAbsolutePath(o) ||
            ((e.Utilities.startsWith(o, './') || e.Utilities.startsWith(o, '../')) &&
              (o = t._normalizeModuleId(this.fromModulePath + o))),
          o
        );
      }),
      t
  ...
  var n = (function() {
    ...
    return (
      ...
      (t._invokeFactory = function(t, n, o, r) {
        return t.isBuild() && !e.Utilities.isAnonymousModule(n)
          ? { returnedValue: null, producedError: null }
          : t.shouldCatchError()
          ? this._safeInvokeFunction(o, r)
          : { returnedValue: o.apply(e.global, r), producedError: null };
      }),
      (t.prototype.complete = function(n, o, r) {
        this._isComplete = !0;
        var i = null;
        if (this._callback)
          if ('function' == typeof this._callback) {
            n.record(21, this.strId);
            var s = t._invokeFactory(o, this.strId, this._callback, r);
            (i = s.producedError),
        ...
        i && o.onError({ errorCode: 'factory', moduleId: this.strId, detail: i }),
  ...
  (r.EXPORTS = new r(0)), (r.MODULE = new r(1)), (r.REQUIRE = new r(2)), (e.RegularDependency = r);
  var i = (function() {
    return function(e, t, n) {
  ...
  var s = (function() {
    ...
    return (
      ...
      (s.prototype.getBuildInfo = function() {
        ...
        for (var e = [], t = 0, n = 0, o = this._modules2.length; n < o; n++) {
          var r = this._modules2[n];
          if (r) {
            var i = this._buildInfoPath[r.id] || null,
              a = this._buildInfoDefineStack[r.id] || null,
              d = this._buildInfoDependencies[r.id];
            e[t++] = {
              id: r.strId,
              path: i,
      ...
      (s.prototype.defineModule = function(e, o, r, i, s, a) {
        var d = this;
        void 0 === a && (a = new t(e));
        ...
        if (this._modules2[u])
          ...
          var l = new n(u, e, this._normalizeDependencies(o, a), r, i, a);
          (this._modules2[u] = l),
      ...
      (s.prototype._normalizeDependency = function(e, t) {
        ...
        var n = e.indexOf('!');
        if (n >= 0) {
          var o = t.resolveModule(e.substr(0, n)),
            s = t.resolveModule(e.substr(n + 1)),
            a = this._moduleIdProvider.getModuleId(o + '!' + s),
            d = this._moduleIdProvider.getModuleId(o);
          return new i(a, d, s);
        }
        return new r(this._moduleIdProvider.getModuleId(t.resolveModule(e)));
      }),
      (s.prototype._normalizeDependencies = function(e, t) {
        for (var n = [], o = 0, r = 0, i = e.length; r < i; r++)
          n[o++] = this._normalizeDependency(e[r], t);
        return n;
      }),
      (s.prototype._relativeRequire = function(t, n, o, r) {
        if ('string' == typeof n) return this.synchronousRequire(n, t);
        this.defineModule(e.Utilities.generateAnonymousModule(), n, o, r, null, t);
      }),
      (s.prototype.synchronousRequire = function(e, n) {
        void 0 === n && (n = new t(e));
        var o = this._normalizeDependency(e, n),
          r = this._modules2[o.id];
        if (!r)
          throw new Error(
      ...
      (s.prototype.configure = function(t, n) {
        ...
        (this._config = n ? new e.Configuration(this._env, t) : this._config.cloneAndMerge(t)),
          this._config.shouldRecordStats() && !o && (this._recorder = null);
      }),
      ...
      (s.prototype._hasDependencyPath = function(e, t) {
        ...
        if (!n) return !1;
        for (var o = [], r = 0, i = this._moduleIdProvider.getMaxModuleId(); r < i; r++) o[r] = !1;
        var s = [];
        for (s.push(n), o[e] = !0; s.length > 0; ) {
      ...
      (s.prototype._findCyclePath = function(e, t, n) {
        ...
        if (!o) return null;
        for (var r = o.dependencies, i = 0, s = r.length; i < s; i++) {
          var a = this._findCyclePath(r[i].id, t, n + 1);
      ...
      (s.prototype._createRequire = function(t) {
        var n = this,
          o = function(e, o, r) {
            return n._relativeRequire(t, e, o, r);
          };
        return (
          (o.toUrl = function(e) {
          ...
          (o.__$__nodeRequire = e.global.nodeRequire),
          o
        );
      }),
      (s.prototype._loadModule = function(e) {
        ...
        if (!this._modules2[e] && !this._knownModules2[e]) {
          ...
          var r = -1,
            i = function(n) {
              if (++r >= o.length) t._onLoadError(e, n);
              else {
                var s = o[r],
                  a = t.getRecorder();
      ...
      (s.prototype._loadPluginDependency = function(e, n) {
        ...
        if (!this._modules2[n.id] && !this._knownModules2[n.id]) {
          ...
          var r = function(e) {
            o.defineModule(o._moduleIdProvider.getStrModuleId(n.id), [], e, null, null);
          };
          (r.error = function(e) {
            o._config.onError(o._createLoadError(n.id, e));
          }),
            e.load(n.pluginParam, this._createRequire(t.ROOT), r, this._config.getOptionsLiteral());
        }
      }),
      (s.prototype._resolve = function(e) {
        for (var t = this, n = e.dependencies, o = 0, s = n.length; o < s; o++) {
          var a = n[o];
          if (a !== r.EXPORTS)
            if (a !== r.MODULE)
              if (a !== r.REQUIRE) {
      ...
      (s.prototype._onModuleComplete = function(e) {
        var t = this,
          n = this.getRecorder();
        if (!e.isComplete()) {
          for (var o = e.dependencies, i = [], s = 0, a = o.length; s < a; s++) {
            var d = o[s];
            if (d !== r.EXPORTS)
              if (d !== r.MODULE)
                if (d !== r.REQUIRE) {
  ...
  function t() {
    if (void 0 !== e.global.require || 'undefined' != typeof require) {
      ...
      if ('function' == typeof t && 'function' == typeof t.resolve) {
        var i = function(e) {
          o.getRecorder().record(33, e);
          try {
            return t(e);
          } finally {
            o.getRecorder().record(34, e);
          }
        };
    ...
    n.isNode && !n.isElectronRenderer
      ...
      : (n.isElectronRenderer || (e.global.define = r), (e.global.require = s));
  }
  var n = new e.Environment(),
    ...
    r = function(e, t, n) {
      'string' != typeof e && ((n = t), (t = e), (e = null)),
        ...
        e ? o.defineModule(e, t, n, null, null) : o.enqueueDefineAnonymousModule(t, n);
    };
  r.amd = {
    jQuery: !0,
  };
  var i = function(e, t) {
      void 0 === t && (t = !1), o.configure(e, t);
    },
    s = function() {
